...
var n=function(e,t,n){if("string"==typeof t){var o=r(e,t)
if(null!=o)return n&&n(),o}else if("[object Array]"===Object.prototype.toString.call(t)){for(var s=[],a=0,l=t.length;a<l;++a){var c=r(e,t[a])
if(null==c&&i.original)return
s.push(c)}return n&&n.apply(null,s)||!0}},i=function(e,t){var o=n("",e,t)
return null==o&&i.original?i.original.apply(this,arguments):o},o=function(e,t){if(-1!==t.indexOf("!")){var n=t.split("!")
return o(e,n[0])+"!"+o(e,n[1])}if("."==t.charAt(0))for(t=e.split("/").slice(0,-1).join("/")+"/"+t;-1!==t.indexOf(".")&&i!=t;){var i=t
t=t.replace(/\/\.\//,"/").replace(/[^\/]+\/\.\.\//,"")}return t},r=function(e,i){i=o(e,i)
var r=t.modules[i]
if(!r){if("function"==typeof(r=t.payloads[i])){var s={},a={id:i,uri:"",exports:s,packaged:!0},l=r((function(e,t){return n(i,e,t)}),s,a)
s=l||a.exports,t.modules[i]=s,delete t.payloads[i]}r=t.modules[i]=s||r}return r};(function(n){var o=e
n&&(e[n]||(e[n]={}),o=e[n]),o.define&&o.define.packaged||(t.original=o.define,o.define=t,o.define.packaged=!0),o.require&&o.require.packaged||(i.original=o.require,o.require=i,o.require.packaged=!0)})("ace")})(),ace.define("ace/lib/es6-shim",["require","exports","module"],(function(e,t,n){function i(e,t,n){Object.defineProperty(e,t,{value:n,enumerable:!1,writable:!0,configurable:!0})}String.prototype.startsWith||i(String.prototype,"startsWith",(function(e,t){return t=t||0,this.lastIndexOf(e,t)===t})),String.prototype.endsWith||i(String.prototype,"endsWith",(function(e,t){var n=this;(void 0===t||t>n.length)&&(t=n.length),t-=e.length
var i=n.indexOf(e,t)
...
e("./es6-shim")})),ace.define("ace/lib/deep_copy",["require","exports","module"],(function(e,t,n){t.deepCopy=function e(t){if("object"!=typeof t||!t)return t
var n
...
return n}})),ace.define("ace/lib/lang",["require","exports","module","ace/lib/deep_copy"],(function(e,t,n){"use strict"
...
return t},t.deepCopy=e("./deep_copy").deepCopy,t.arrayToMap=function(e){for(var t={},n=0;n<e.length;n++)t[e[n]]=1
...
return o.delay=function(e){n&&clearTimeout(n),n=setTimeout(i,e||t)},o.schedule=o,o.call=function(){this.cancel(),e()},o.cancel=function(){n&&clearTimeout(n),n=null},o.isPending=function(){return n},o},t.supportsLookbehind=function(){try{new RegExp("(?<=.)")}catch(e){return!1}return!0},t.skipEmptyMatch=function(e,t,n){return n&&e.codePointAt(t)>65535?2:1}})),ace.define("ace/lib/useragent",["require","exports","module"],(function(e,t,n){"use strict"
...
function i(){var e=a
a=null,e&&e.forEach((function(e){o(e[0],e[1])}))}function o(e,n,o){if("undefined"!=typeof document){if(a)if(o)i()
...
c.appendChild(l.createTextNode(e)),n&&(c.id=n),r==l&&(r=t.getDocumentHead(l)),r.insertBefore(c,r.firstChild)}}}var r=e("./useragent")
...
var s,a=[]
if(t.useStrictCSP=function(e){s=e,0==e?i():a||(a=[])},t.importCssString=o,t.importCssStylsheet=function(e,n){t.buildDom(["link",{rel:"stylesheet",href:e}],t.getDocumentHead(n))},t.scrollbarWidth=function(e){var n=t.createElement("ace_inner")
...
return n?n.forwardTo?this[n.forwardTo]&&this[n.forwardTo].setOption(e,t):(n.handlesSet||(this["$"+e]=t),void(n&&n.set&&n.set.call(this,t))):i('misspelled option "'+e+'"')}},getOption:function(e){var t=this.$options[e]
return t?t.forwardTo?this[t.forwardTo]&&this[t.forwardTo].getOption(e):t&&t.get?t.get.call(this):this["$"+e]:i('misspelled option "'+e+'"')}},u=function(){function e(){this.$defaultOptions={},o=c,r="dollarSigns"}return e.prototype.defineOptions=function(e,t,n){return e.$options||(this.$defaultOptions[t]=e.$options={}),Object.keys(n).forEach((function(t){var i=n[t]
"string"==typeof i&&(i={forwardTo:i}),i.name||(i.name=t),e.$options[i.name]=i,"initialValue"in i&&(e["$"+i.name]=i.initialValue)})),s.implement(e,h),this},e.prototype.resetOptions=function(e){Object.keys(e.$options).forEach((function(t){var n=e.$options[t]
...
i[t]&&(i.forwardTo?this.setDefaultValue(i.forwardTo,t,n):i[t].value=n)},e.prototype.setDefaultValues=function(e,t){Object.keys(t).forEach((function(n){this.setDefaultValue(e,n,t[n])}),this)},e.prototype.setMessages=function(e,t){o=e,t&&t.placeholders&&(r=t.placeholders)},e.prototype.nls=function(e,t,n){o[e]||(i("No message found for the key '"+e+"' in messages with id "+o.$id+", trying to find a translation for the default string '"+t+"'."),o[t]||i("No message found for the default string '"+t+"' in the provided messages. Falling back to the default English message."))
var s=o[e]||o[t]||t
return n&&("dollarSigns"===r&&(s=s.replace(/\$(\$|[\d]+)/g,(function(e,t){return"$"==t?"$":n[t]}))),"curlyBrackets"===r&&(s=s.replace(/\{([^\}]+)\}/g,(function(e,t){return n[t]})))),s},e}()
u.prototype.warn=i,u.prototype.reportError=l,s.implement(u.prototype,a),t.AppConfig=u})),ace.define("ace/theme/textmate-css",["require","exports","module"],(function(e,t,n){n.exports='.ace-tm .ace_gutter {\n  background: #f0f0f0;\n  color: #333;\n}\n\n.ace-tm .ace_print-margin {\n  width: 1px;\n  background: #e8e8e8;\n}\n\n.ace-tm .ace_fold {\n    background-color: #6B72E6;\n}\n\n.ace-tm {\n  background-color: #FFFFFF;\n  color: black;\n}\n\n.ace-tm .ace_cursor {\n  color: black;\n}\n        \n.ace-tm .ace_invisible {\n  color: rgb(191, 191, 191);\n}\n\n.ace-tm .ace_storage,\n.ace-tm .ace_keyword {\n  color: blue;\n}\n\n.ace-tm .ace_constant {\n  color: rgb(197, 6, 11);\n}\n\n.ace-tm .ace_constant.ace_buildin {\n  color: rgb(88, 72, 246);\n}\n\n.ace-tm .ace_constant.ace_language {\n  color: rgb(88, 92, 246);\n}\n\n.ace-tm .ace_constant.ace_library {\n  color: rgb(6, 150, 14);\n}\n\n.ace-tm .ace_invalid {\n  background-color: rgba(255, 0, 0, 0.1);\n  color: red;\n}\n\n.ace-tm .ace_support.ace_function {\n  color: rgb(60, 76, 114);\n}\n\n.ace-tm .ace_support.ace_constant {\n  color: rgb(6, 150, 14);\n}\n\n.ace-tm .ace_support.ace_type,\n.ace-tm .ace_support.ace_class {\n  color: rgb(109, 121, 222);\n}\n\n.ace-tm .ace_keyword.ace_operator {\n  color: rgb(104, 118, 135);\n}\n\n.ace-tm .ace_string {\n  color: rgb(3, 106, 7);\n}\n\n.ace-tm .ace_comment {\n  color: rgb(76, 136, 107);\n}\n\n.ace-tm .ace_comment.ace_doc {\n  color: rgb(0, 102, 255);\n}\n\n.ace-tm .ace_comment.ace_doc.ace_tag {\n  color: rgb(128, 159, 191);\n}\n\n.ace-tm .ace_constant.ace_numeric {\n  color: rgb(0, 0, 205);\n}\n\n.ace-tm .ace_variable {\n  color: rgb(49, 132, 149);\n}\n\n.ace-tm .ace_xml-pe {\n  color: rgb(104, 104, 91);\n}\n\n.ace-tm .ace_entity.ace_name.ace_function {\n  color: #0000A2;\n}\n\n\n.ace-tm .ace_heading {\n  color: rgb(12, 7, 255);\n}\n\n.ace-tm .ace_list {\n  color:rgb(185, 6, 144);\n}\n\n.ace-tm .ace_meta.ace_tag {\n  color:rgb(0, 22, 142);\n}\n\n.ace-tm .ace_string.ace_regex {\n  color: rgb(255, 0, 0)\n}\n\n.ace-tm .ace_marker-layer .ace_selection {\n  background: rgb(181, 213, 255);\n}\n.ace-tm.ace_multiselect .ace_selection.ace_start {\n  box-shadow: 0 0 3px 0px white;\n}\n.ace-tm .ace_marker-layer .ace_step {\n  background: rgb(252, 255, 0);\n}\n\n.ace-tm .ace_marker-layer .ace_stack {\n  background: rgb(164, 229, 101);\n}\n\n.ace-tm .ace_marker-layer .ace_bracket {\n  margin: -1px 0 0 -1px;\n  border: 1px solid rgb(192, 192, 192);\n}\n\n.ace-tm .ace_marker-layer .ace_active-line {\n  background: rgba(0, 0, 0, 0.07);\n}\n\n.ace-tm .ace_gutter-active-line {\n    background-color : #dcdcdc;\n}\n\n.ace-tm .ace_marker-layer .ace_selected-word {\n  background: rgb(250, 250, 255);\n  border: 1px solid rgb(200, 200, 250);\n}\n\n.ace-tm .ace_indent-guide {\n  background: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAACCAYAAACZgbYnAAAAE0lEQVQImWP4////f4bLly//BwAmVgd1/w11/gAAAABJRU5ErkJggg==") right repeat-y;\n}\n\n.ace-tm .ace_indent-guide-active {\n  background: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAACCAYAAACZgbYnAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAIGNIUk0AAHolAACAgwAA+f8AAIDpAAB1MAAA6mAAADqYAAAXb5JfxUYAAAAZSURBVHjaYvj///9/hivKyv8BAAAA//8DACLqBhbvk+/eAAAAAElFTkSuQmCC") right repeat-y;\n}\n'})),ace.define("ace/theme/textmate",["require","exports","module","ace/theme/textmate-css","ace/lib/dom"],(function(e,t,n){"use strict"
...
"useStrictCSP"==e&&r.useStrictCSP(t)},t.all=function(){return i.copyObject(a)},t.$modes={},t.moduleUrl=function(e,t){if(a.$moduleUrls[e])return a.$moduleUrls[e]
...
var s=a[t+"Path"]
return null==s?s=a.basePath:"/"==i&&(t=i=""),s&&"/"!=s.slice(-1)&&(s+="/"),s+t+i+o+this.get("suffix")},t.setModuleUrl=function(e,t){return a.$moduleUrls[e]=t}
var l,c=function(t,n){return"ace/theme/textmate"===t||"./theme/textmate"===t?n(null,e("./theme/textmate")):l?l(t,n):void console.error("loader is not configured")}
t.setLoader=function(e){l=e},t.dynamicModules=Object.create(null),t.$loading={},t.$loaded={},t.loadModule=function(e,n){var i
if(Array.isArray(e))var r=e[0],s=e[1]
else if("string"==typeof e)s=e
var a=function(e){if(e&&!t.$loading[s])return n&&n(e)
if(t.$loading[s]||(t.$loading[s]=[]),t.$loading[s].push(n),!(t.$loading[s].length>1)){var i=function(){c(s,(function(e,n){n&&(t.$loaded[s]=n),t._emit("load.module",{name:s,module:n})
var i=t.$loading[s]
t.$loading[s]=null,i.forEach((function(e){e&&e(n)}))}))}
if(!t.get("packaged"))return i()
o.loadScript(t.moduleUrl(s,r),i),h()}}
if(t.dynamicModules[s])t.dynamicModules[s]().then((function(e){e.default?a(e.default):a(e)}))
else{try{i=this.$require(s)}catch(l){}a(i||t.$loaded[s])}},t.$require=function(e){if("function"==typeof n.require){return n.require(e)}},t.setModuleLoader=function(e,n){t.dynamicModules[e]=n}
...
t.version="1.38.0"})),ace.define("ace/loader_build",["require","exports","module","ace/lib/fixoldbrowsers","ace/config"],(function(e,t,n){"use strict"
function i(t){if(s&&s.document){r.set("packaged",t||e.packaged||n.packaged||s.define&&define.packaged)
var i={},a="",l=document.currentScript||document._currentScript,c=l&&l.ownerDocument||document
l&&l.src&&(a=l.src.split(/[?#]/)[0].split("/").slice(0,-1).join("/")||"")
for(var h=c.getElementsByTagName("script"),u=0;u<h.length;u++){var d=h[u],g=d.src||d.getAttribute("src")
if(g){for(var p=d.attributes,f=0,m=p.length;f<m;f++){var y=p[f]
0===y.name.indexOf("data-ace-")&&(i[o(y.name.replace(/^data-ace-/,""))]=y.value)}var v=g.match(/^(.*)\/ace([\-.]\w+)?\.js(\?|$)/)
v&&(a=v[1])}}for(var w in a&&(i.base=i.base||a,i.packaged=!0),i.basePath=i.base,i.workerPath=i.workerPath||i.base,i.modePath=i.modePath||i.base,i.themePath=i.themePath||i.base,delete i.base,i)void 0!==i[w]&&r.set(w,i[w])}}function o(e){return e.replace(/-(.)/g,(function(e,t){return t.toUpperCase()}))}e("./lib/fixoldbrowsers")
var r=e("./config")
r.setLoader((function(t,n){e([t],(function(e){n(null,e)}))}))
var s=function(){return this||"undefined"!=typeof window&&window}()
n.exports=function(t){r.init=i,r.$require=e,t.require=e,"function"==typeof define&&(t.define=define)}})),ace.define("ace/range",["require","exports","module"],(function(e,t,n){"use strict"
...
i.fromPoints=function(e,t){return new i(e.row,e.column,t.row,t.column)},i.comparePoints=function(e,t){return e.row-t.row||e.column-t.column},t.Range=i})),ace.define("ace/lib/keys",["require","exports","module","ace/lib/oop"],(function(e,t,n){"use strict"
for(var i=e("./oop"),o={MODIFIER_KEYS:{16:"Shift",17:"Ctrl",18:"Alt",224:"Meta",91:"MetaLeft",92:"MetaRight",93:"ContextMenu"},KEY_MODS:{ctrl:1,alt:2,option:2,shift:4,super:8,meta:8,command:8,cmd:8,control:1},FUNCTION_KEYS:{8:"Backspace",9:"Tab",13:"Return",19:"Pause",27:"Esc",32:"Space",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"Left",38:"Up",39:"Right",40:"Down",44:"Print",45:"Insert",46:"Delete","-13":"NumpadEnter",144:"Numlock",145:"Scrolllock"},PRINTABLE_KEYS:{32:" ",59:";",61:"=",107:"+",109:"-",110:".",186:";",187:"=",188:",",189:"-",190:".",191:"/",192:"`",219:"[",220:"\\",221:"]",222:"'",111:"/",106:"*"}},r={Command:224,Backspace:8,Tab:9,Return:13,Enter:13,Pause:19,Escape:27,PageUp:33,PageDown:34,End:35,Home:36,Insert:45,Delete:46,ArrowLeft:37,ArrowUp:38,ArrowRight:39,ArrowDown:40,Backquote:192,Minus:189,Equal:187,BracketLeft:219,Backslash:220,BracketRight:221,Semicolon:186,Quote:222,Comma:188,Period:190,Slash:191,Space:32,NumpadAdd:107,NumpadDecimal:110,NumpadSubtract:109,NumpadDivide:111,NumpadMultiply:106},s=0;s<10;s++)r["Digit"+s]=48+s,r["Numpad"+s]=96+s,o.PRINTABLE_KEYS[48+s]=""+s,o.FUNCTION_KEYS[96+s]="Numpad"+s
for(s=65;s<91;s++){var a=String.fromCharCode(s+32)
r["Key"+a.toUpperCase()]=s,o.PRINTABLE_KEYS[s]=a}for(s=1;s<13;s++)r["F"+s]=111+s,o.FUNCTION_KEYS[111+s]="F"+s
var l={Shift:16,Control:17,Alt:18,Meta:224}
for(var c in l)r[c]=r[c+"Left"]=r[c+"Right"]=l[c]
for(var h in t.$codeToKeyCode=r,o.PRINTABLE_KEYS[173]="-",o.FUNCTION_KEYS){var u=o.FUNCTION_KEYS[h].toLowerCase()
o[u]=parseInt(h,10)}for(var h in o.PRINTABLE_KEYS){u=o.PRINTABLE_KEYS[h].toLowerCase()
o[u]=parseInt(h,10)}i.mixin(o,o.MODIFIER_KEYS),i.mixin(o,o.PRINTABLE_KEYS),i.mixin(o,o.FUNCTION_KEYS),o.enter=o.return,o.escape=o.esc,o.del=o.delete,function(){for(var e=["cmd","ctrl","alt","shift"],t=Math.pow(2,e.length);t--;)o.KEY_MODS[t]=e.filter((function(e){return t&o.KEY_MODS[e]})).join("-")+"-"}(),o.KEY_MODS[0]="",o.KEY_MODS[-1]="input-",i.mixin(t,o),t.default=t,t.keyCodeToString=function(e){var t=o[e]
...
function i(){return null==l&&function(){l=!1
try{document.createComment("").addEventListener("test",(function(){}),{get passive(){return l={passive:!1},!0}})}catch(e){}}(),l}function o(e,t,n){this.elem=e,this.type=t,this.callback=n}function r(e){return(e.ctrlKey?1:0)|(e.altKey?2:0)|(e.shiftKey?4:0)|(e.metaKey?8:0)}function s(e,t,n){var i=r(t)
if(!n&&t.code&&(n=c.$codeToKeyCode[t.code]||n),!h.isMac&&u){if(t.getModifierState&&(t.getModifierState("OS")||t.getModifierState("Win"))&&(i|=8),u.altGr){if(!(3&~i))return
u.altGr=0}if(18===n||17===n){var o=t.location
if(17===n&&1===o)1==u[n]&&(d=t.timeStamp)
else if(18===n&&3===i&&2===o){t.timeStamp-d<50&&(u.altGr=!0)}}}if(n in c.MODIFIER_KEYS&&(n=-1),i||13!==n||3!==t.location||(e(t,i,-n),!t.defaultPrevented)){if(h.isChromeOS&&8&i){if(e(t,i,n),t.defaultPrevented)return
i&=-9}return!!(i||n in c.FUNCTION_KEYS||n in c.PRINTABLE_KEYS)&&e(t,i,n)}}function a(){u=Object.create(null)}var l,c=e("./keys"),h=e("./useragent"),u=null,d=0
o.prototype.destroy=function(){p(this.elem,this.type,this.callback),this.elem=this.type=this.callback=void 0}
var g=t.addListener=function(e,t,n,r){e.addEventListener(t,n,i()),r&&r.$toDestroy.push(new o(e,t,n))},p=t.removeListener=function(e,t,n){e.removeEventListener(t,n,i())}
if(t.stopEvent=function(e){return t.stopPropagation(e),t.preventDefault(e),!1},t.stopPropagation=function(e){e.stopPropagation&&e.stopPropagation()},t.preventDefault=function(e){e.preventDefault&&e.preventDefault()},t.getButton=function(e){return"dblclick"==e.type?0:"contextmenu"==e.type||h.isMac&&e.ctrlKey&&!e.altKey&&!e.shiftKey?2:e.button},t.capture=function(e,t,n){function i(e){t&&t(e),n&&n(e),p(o,"mousemove",t),p(o,"mouseup",i),p(o,"dragstart",i)}var o=e&&e.ownerDocument||document
return g(o,"mousemove",t),g(o,"mouseup",i),g(o,"dragstart",i),i},t.addMouseWheelListener=function(e,t,n){g(e,"wheel",(function(e){var n=e.deltaX||0,i=e.deltaY||0
switch(e.deltaMode){case e.DOM_DELTA_PIXEL:e.wheelX=.15*n,e.wheelY=.15*i
break
case e.DOM_DELTA_LINE:e.wheelX=15*n,e.wheelY=15*i
break
case e.DOM_DELTA_PAGE:e.wheelX=150*n,e.wheelY=150*i}t(e)}),n)},t.addMultiMouseDownListener=function(e,n,i,o,r){function s(e){if(0!==t.getButton(e)?u=0:e.detail>1?++u>4&&(u=1):u=1,h.isIE){var r=Math.abs(e.clientX-a)>5||Math.abs(e.clientY-l)>5
c&&!r||(u=1),c&&clearTimeout(c),c=setTimeout((function(){c=null}),n[u-1]||600),1==u&&(a=e.clientX,l=e.clientY)}if(e._clicks=u,i[o]("mousedown",e),u>4)u=0
else if(u>1)return i[o](d[u],e)}var a,l,c,u=0,d={2:"dblclick",3:"tripleclick",4:"quadclick"}
Array.isArray(e)||(e=[e]),e.forEach((function(e){g(e,"mousedown",s,r)}))},t.getModifierString=function(e){return c.KEY_MODS[r(e)]},t.addCommandKeyListener=function(e,n,i){var o=null
g(e,"keydown",(function(e){u[e.keyCode]=(u[e.keyCode]||0)+1
var t=s(n,e,e.keyCode)
return o=e.defaultPrevented,t}),i),g(e,"keypress",(function(e){o&&(e.ctrlKey||e.altKey||e.shiftKey||e.metaKey)&&(t.stopEvent(e),o=null)}),i),g(e,"keyup",(function(e){u[e.keyCode]=null}),i),u||(a(),g(window,"focus",a))},"object"==typeof window&&window.postMessage&&!h.isOldIE){var f=1
t.nextTick=function(e,n){n=n||window
var i="zero-timeout-message-"+f++,o=function(r){r.data==i&&(t.stopPropagation(r),p(n,"message",o),e())}
g(n,"message",o),n.postMessage(i,"*")}}t.$idleBlocked=!1,t.onIdle=function(e,n){return setTimeout((function n(){t.$idleBlocked?setTimeout(n,100):e()}),n)},t.$idleBlockId=null,t.blockIdle=function(e){t.$idleBlockId&&clearTimeout(t.$idleBlockId),t.$idleBlocked=!0,t.$idleBlockId=setTimeout((function(){t.$idleBlocked=!1}),e||100)},t.nextFrame="object"==typeof window&&(window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame||window.oRequestAnimationFrame),t.nextFrame?t.nextFrame=t.nextFrame.bind(window):t.nextFrame=function(e){setTimeout(e,17)}})),ace.define("ace/clipboard",["require","exports","module"],(function(e,t,n){"use strict"
var i
...
var i,o=e("../lib/event"),r=e("../config").nls,s=e("../lib/useragent"),a=e("../lib/dom"),l=e("../lib/lang"),c=e("../clipboard"),h=s.isChrome<18,u=s.isIE,d=s.isChrome>63,g=400,p=e("../lib/keys"),f=p.KEY_MODS,m=s.isIOS,y=m?/\s/:/\n/,v=s.isMobile
i=function(e,t){function n(){M=!0,w.blur(),w.focus(),M=!1}function i(){clearTimeout(Q),Q=setTimeout((function(){x&&(w.style.cssText=x,x=""),t.renderer.$isMousePressed=!1,t.renderer.$keepTextAreaAtCursor&&t.renderer.$moveTextAreaToCursor()}),0)}var w=a.createElement("textarea")
w.className="ace_text-input",w.setAttribute("wrap","off"),w.setAttribute("autocorrect","off"),w.setAttribute("autocapitalize","off"),w.setAttribute("spellcheck","false"),w.style.opacity="0",e.insertBefore(w,e.firstChild)
var b=!1,$=!1,C=!1,S=!1,x=""
v||(w.style.fontSize="1px")
var A=!1,M=!1,k="",L=0,T=0,E=0,R=Number.MAX_SAFE_INTEGER,_=Number.MIN_SAFE_INTEGER,I=0
try{var D=document.activeElement===w}catch(X){}this.setNumberOfExtraLines=function(e){R=Number.MAX_SAFE_INTEGER,_=Number.MIN_SAFE_INTEGER,I=e<0?0:e},this.setAriaLabel=function(){var e=""
if(t.$textInputAriaLabel&&(e+="".concat(t.$textInputAriaLabel,", ")),t.session){var n=t.session.selection.cursor.row
e+=r("text-input.aria-label","Cursor at row $0",[n+1])}w.setAttribute("aria-label",e)},this.setAriaOptions=function(e){e.activeDescendant?(w.setAttribute("aria-haspopup","true"),w.setAttribute("aria-autocomplete",e.inline?"both":"list"),w.setAttribute("aria-activedescendant",e.activeDescendant)):(w.setAttribute("aria-haspopup","false"),w.setAttribute("aria-autocomplete","both"),w.removeAttribute("aria-activedescendant")),e.role&&w.setAttribute("role",e.role),e.setLabel&&(w.setAttribute("aria-roledescription",r("text-input.aria-roledescription","editor")),this.setAriaLabel())},this.setAriaOptions({role:"textbox"}),o.addListener(w,"blur",(function(e){M||(t.onBlur(e),D=!1)}),t),o.addListener(w,"focus",(function(e){if(!M){if(D=!0,s.isEdge)try{if(!document.hasFocus())return}catch(e){}t.onFocus(e),s.isEdge?setTimeout(O):O()}}),t),this.$focusScroll=!1,this.focus=function(){if(this.setAriaOptions({setLabel:t.renderer.enableKeyboardAccessibility}),x||d||"browser"==this.$focusScroll)return w.focus({preventScroll:!0})
var e=w.style.top
w.style.position="fixed",w.style.top="0px"
try{var n=0!=w.getBoundingClientRect().top}catch(r){return}var i=[]
if(n)for(var o=w.parentElement;o&&1==o.nodeType;)i.push(o),o.setAttribute("ace_nocontext","true"),o=!o.parentElement&&o.getRootNode?o.getRootNode().host:o.parentElement
w.focus({preventScroll:!0}),n&&i.forEach((function(e){e.removeAttribute("ace_nocontext")})),setTimeout((function(){w.style.position="","0px"==w.style.top&&(w.style.top=e)}),0)},this.blur=function(){w.blur()},this.isFocused=function(){return D},t.on("beforeEndOperation",(function(){var e=t.curOp,n=e&&e.command&&e.command.name
if("insertstring"!=n){var i=n&&(e.docChanged||e.selectionChanged)
C&&i&&(k=w.value="",K()),O()}})),t.on("changeSelection",this.setAriaLabel)
var N=function(e,n){for(var i=n,o=1;o<=e-R&&o<2*I+1;o++)i+=t.session.getLine(e-o).length+1
return i},O=m?function(e){if(D&&(!b||e)&&!S){e||(e="")
var n="\n ab"+e+"cde fg\n"
n!=w.value&&(w.value=k=n)
var i=4+(e.length||(t.selection.isEmpty()?0:1));(4!=L||T!=i)&&w.setSelectionRange(4,i),L=4,T=i}}:function(){if(!C&&!S&&(D||F)){C=!0
var e=0,n=0,i=""
if(t.session){var o=t.selection,r=o.getRange(),s=o.cursor.row
s===_+1?_=(R=_+1)+2*I:s===R-1?R=(_=R-1)-2*I:(s<R-1||s>_+1)&&(R=s>I?s-I:0,_=s>I?s+I:2*I)
for(var a=[],l=R;l<=_;l++)a.push(t.session.getLine(l))
if(i=a.join("\n"),e=N(r.start.row,r.start.column),n=N(r.end.row,r.end.column),r.start.row<R){var c=t.session.getLine(R-1)
e=r.start.row<R-1?0:e,n+=c.length+1,i=c+"\n"+i}else if(r.end.row>_){var h=t.session.getLine(_+1)
n=r.end.row>_+1?h.length:r.end.column,n+=i.length+1,i=i+"\n"+h}else v&&s>0&&(i="\n"+i,n+=1,e+=1)
i.length>g&&(e<g&&n<g?i=i.slice(0,g):(i="\n",e==n?e=n=0:(e=0,n=1)))
var u=i+"\n\n"
u!=k&&(w.value=k=u,L=T=u.length)}if(F&&(L=w.selectionStart,T=w.selectionEnd),T!=n||L!=e||w.selectionEnd!=T)try{w.setSelectionRange(e,n),L=e,T=n}catch(f){}C=!1}}
this.resetSelection=O,D&&t.onFocus()
var W=null
this.setInputHandler=function(e){W=e},this.getInputHandler=function(){return W}
var F=!1,z=function(e,n){if(F&&(F=!1),$)return O(),e&&t.onPaste(e),$=!1,""
for(var i=w.selectionStart,o=w.selectionEnd,r=L,a=k.length-T,l=e,c=e.length-i,h=e.length-o,u=0;r>0&&k[u]==e[u];)u++,r--
for(l=l.slice(u),u=1;a>0&&k.length-u>L-1&&k[k.length-u]==e[e.length-u];)u++,a--
c-=u-1,h-=u-1
var d=l.length-u+1
if(d<0&&(r=-d,d=0),l=l.slice(0,d),!(n||l||c||r||a||h))return""
S=!0
var g=!1
return s.isAndroid&&". "==l&&(l="  ",g=!0),l&&!r&&!a&&!c&&!h||A?t.onTextInput(l):t.onTextInput(l,{extendLeft:r,extendRight:a,restoreStart:c,restoreEnd:h}),S=!1,k=e,L=i,T=o,E=h,g?"\n":l},H=function(e){if(C)return G()
if(e&&e.inputType){if("historyUndo"==e.inputType)return t.execCommand("undo")
if("historyRedo"==e.inputType)return t.execCommand("redo")}var n=w.value,i=z(n,!0);(n.length>500||y.test(i)||v&&L<1&&L==T)&&O()},B=function(e,t,n){var i=e.clipboardData||window.clipboardData
if(i&&!h){var o=u||n?"Text":"text/plain"
try{return t?!1!==i.setData(o,t):i.getData(o)}catch(e){if(!n)return B(e,t,!0)}}},P=function(e,n){var i=t.getCopyText()
if(!i)return o.preventDefault(e)
B(e,i)?(m&&(O(i),b=i,setTimeout((function(){b=!1}),10)),n?t.onCut():t.onCopy(),o.preventDefault(e)):(b=!0,w.value=i,w.select(),setTimeout((function(){b=!1,O(),n?t.onCut():t.onCopy()})))},j=function(e){P(e,!0)},U=function(e){P(e,!1)},V=function(e){var n=B(e)
c.pasteCancelled()||("string"==typeof n?(n&&t.onPaste(n,e),s.isIE&&setTimeout(O),o.preventDefault(e)):(w.value="",$=!0))}
o.addCommandKeyListener(w,(function(e,n,i){if(!C)return t.onCommandKey(e,n,i)}),t),o.addListener(w,"select",(function(e){C||(b?b=!1:function(e){return 0===e.selectionStart&&e.selectionEnd>=k.length&&e.value===k&&k&&e.selectionEnd!==T}(w)?(t.selectAll(),O()):v&&w.selectionStart!=L&&O())}),t),o.addListener(w,"input",H,t),o.addListener(w,"cut",j,t),o.addListener(w,"copy",U,t),o.addListener(w,"paste",V,t),(!("oncut"in w)||!("oncopy"in w)||!("onpaste"in w))&&o.addListener(e,"keydown",(function(e){if((!s.isMac||e.metaKey)&&e.ctrlKey)switch(e.keyCode){case 67:U(e)
break
case 86:V(e)
break
case 88:j(e)}}),t)
var G=function(){if(C&&t.onCompositionUpdate&&!t.$readOnly){if(A)return n()
if(C.useTextareaForIME)t.onCompositionUpdate(w.value)
else{var e=w.value
z(e),C.markerRange&&(C.context&&(C.markerRange.start.column=C.selectionStart=C.context.compositionStartOffset),C.markerRange.end.column=C.markerRange.start.column+T-C.selectionStart+E)}}},K=function(e){t.onCompositionEnd&&!t.$readOnly&&(C=!1,t.onCompositionEnd(),t.off("mousedown",n),e&&H())},Y=l.delayedCall(G,50).schedule.bind(null,null)
o.addListener(w,"compositionstart",(function(e){if(!C&&t.onCompositionStart&&!t.$readOnly&&(C={},!A)){e.data&&(C.useTextareaForIME=!1),setTimeout(G,0),t._signal("compositionStart"),t.on("mousedown",n)
...
var r=t.container.getBoundingClientRect(),l=a.computedStyle(t.container),c=r.top+(parseInt(l.borderTopWidth)||0),h=r.left+(parseInt(l.borderLeftWidth)||0),u=r.bottom-c-w.clientHeight-2,d=function(e){a.translate(w,e.clientX-h-2,Math.min(e.clientY-c-2,u))}
d(e),"mousedown"==e.type&&(t.renderer.$isMousePressed=!0,clearTimeout(Q),s.isWin&&o.capture(t.container,d,i))},this.onContextMenuClose=i
var Q,Z=function(e){t.textInput.onContextMenu(e),i()}
o.addListener(w,"mouseup",Z,t),o.addListener(w,"mousedown",(function(e){e.preventDefault(),i()}),t),o.addListener(t.renderer.scroller,"contextmenu",Z,t),o.addListener(w,"contextmenu",Z,t),m&&function(e,t,n){var i=null,o=!1
...
var r=function(e){if(document.activeElement===n&&!(o||C||t.$mouseHandler.isMousePressed||b)){var i=n.selectionStart,r=n.selectionEnd,s=null,a=0
if(0==i?s=p.up:1==i?s=p.home:r>T&&"\n"==k[r]?s=p.end:i<L&&" "==k[i-1]?(s=p.left,a=f.option):i<L||i==L&&T!=L&&i==r?s=p.left:r>T&&k.slice(0,r).split("\n").length>2?s=p.down:r>T&&" "==k[r-1]?(s=p.right,a=f.option):(r>T||r==T&&T!=L&&i==r)&&(s=p.right),i!==r&&(a|=f.shift),s){if(!t.onCommandKey({},a,s)&&t.commands){s=p.keyCodeToString(s)
var l=t.commands.findKeyCommand(a,s)
l&&t.execCommand(l)}L=i,T=r,O("")}}}
document.addEventListener("selectionchange",r),t.on("destroy",(function(){document.removeEventListener("selectionchange",r)}))}(0,t,w),this.destroy=function(){w.parentElement&&w.parentElement.removeChild(w)}},t.TextInput=i,t.$setUserAgentForTests=function(e,t){v=e,m=t}})),ace.define("ace/mouse/default_handlers",["require","exports","module","ace/lib/useragent"],(function(e,t,n){"use strict"
function i(e,t){if(e.start.row==e.end.row)var n=2*t.column-e.start.column-e.end.column
else if(e.start.row!=e.end.row-1||e.start.column||e.end.column)n=2*t.row-e.start.row-e.end.row
else var n=t.column-4
return n<0?{cursor:e.start,anchor:e.end}:{cursor:e.end,anchor:e.start}}var o=e("../lib/useragent"),r=function(){function e(e){e.$clickSelection=null
var t=e.editor
...
if(this.$clickSelection){var o=this.$clickSelection.comparePoint(n)
if(-1==o)e=this.$clickSelection.end
else if(1==o)e=this.$clickSelection.start
else{var r=i(this.$clickSelection,n)
n=r.cursor,e=r.anchor}t.selection.setSelectionAnchor(e.row,e.column)}t.selection.selectToPosition(n),t.renderer.scrollCursorIntoView()},e.prototype.extendSelectionBy=function(e){var t,n=this.editor,o=n.renderer.screenToTextCoordinates(this.x,this.y),r=n.selection[e](o.row,o.column)
if(this.$clickSelection){var s=this.$clickSelection.comparePoint(r.start),a=this.$clickSelection.comparePoint(r.end)
if(-1==s&&a<=0)t=this.$clickSelection.end,r.end.row==o.row&&r.end.column==o.column||(o=r.start)
else if(1==a&&s>=0)t=this.$clickSelection.start,r.start.row==o.row&&r.start.column==o.column||(o=r.end)
else if(-1==s&&1==a)o=r.end,t=r.start
else{var l=i(this.$clickSelection,o)
o=l.cursor,t=l.anchor}n.selection.setSelectionAnchor(t.row,t.column)}n.selection.selectToPosition(o),n.renderer.scrollCursorIntoView()},e.prototype.selectByLinesEnd=function(){this.$clickSelection=null,this.editor.unsetStyle("ace_selecting")},e.prototype.focusWait=function(){var e=function(e,t,n,i){return Math.sqrt(Math.pow(n-e,2)+Math.pow(i-t,2))}(this.mousedownEvent.x,this.mousedownEvent.y,this.x,this.y),t=Date.now();(e>0||t-this.mousedownEvent.time>this.$focusTimeout)&&this.startSelect(this.mousedownEvent.getDocumentPosition())},e.prototype.onDoubleClick=function(e){var t=e.getDocumentPosition(),n=this.editor,i=n.session.getBracketRange(t)
...
if(a>=1&&t.renderer.isScrollableBy(e.wheelX*e.speed,0)&&(l=!0),a<=1&&t.renderer.isScrollableBy(0,e.wheelY*e.speed)&&(l=!0),l)n.allowed=i
else if(i-n.allowed<550){Math.abs(r)<=1.5*Math.abs(n.vx)&&Math.abs(s)<=1.5*Math.abs(n.vy)?(l=!0,n.allowed=i):n.allowed=0}return n.t=i,n.vx=r,n.vy=s,l?(t.renderer.scrollBy(e.wheelX*e.speed,e.wheelY*e.speed),e.stop()):void 0}},e}()
r.prototype.selectEnd=r.prototype.selectByLinesEnd,r.prototype.selectAllEnd=r.prototype.selectByLinesEnd,r.prototype.selectByWordsEnd=r.prototype.selectByLinesEnd,t.DefaultHandlers=r})),ace.define("ace/lib/scroll",["require","exports","module"],(function(e,t,n){t.preventParentScroll=function(e){e.stopPropagation()
var t=e.currentTarget
t.scrollHeight>t.clientHeight||e.preventDefault()}})),ace.define("ace/tooltip",["require","exports","module","ace/lib/dom","ace/lib/event","ace/range","ace/lib/scroll"],(function(e,t,n){"use strict"
var i=this&&this.__extends||function(){var e=function(t,n){return e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])},e(t,n)}
return function(t,n){function i(){this.constructor=t}if("function"!=typeof n&&null!==n)throw new TypeError("Class extends value "+String(n)+" is not a constructor or null")
e(t,n),t.prototype=null===n?Object.create(n):(i.prototype=n.prototype,new i)}}(),o=this&&this.__values||function(e){var t="function"==typeof Symbol&&Symbol.iterator,n=t&&e[t],i=0
if(n)return n.call(e)
if(e&&"number"==typeof e.length)return{next:function(){return e&&i>=e.length&&(e=void 0),{value:e&&e[i++],done:!e}}}
throw new TypeError(t?"Object is not iterable.":"Symbol.iterator is not defined.")},r=e("./lib/dom"),s=(e("./lib/event"),e("./range").Range),a=e("./lib/scroll").preventParentScroll,l="ace_tooltip",c=function(){function e(e){this.isOpen=!1,this.$element=null,this.$parentNode=e}return e.prototype.$init=function(){return this.$element=r.createElement("div"),this.$element.className=l,this.$element.style.display="none",this.$parentNode.appendChild(this.$element),this.$element},e.prototype.getElement=function(){return this.$element||this.$init()},e.prototype.setText=function(e){this.getElement().textContent=e},e.prototype.setHtml=function(e){this.getElement().innerHTML=e},e.prototype.setPosition=function(e,t){this.getElement().style.left=e+"px",this.getElement().style.top=t+"px"},e.prototype.setClassName=function(e){r.addCssClass(this.getElement(),e)},e.prototype.setTheme=function(e){this.$element.className=l+" "+(e.isDark?"ace_dark ":"")+(e.cssClass||"")},e.prototype.show=function(e,t,n){null!=e&&this.setText(e),null!=t&&null!=n&&this.setPosition(t,n),this.isOpen||(this.getElement().style.display="block",this.isOpen=!0)},e.prototype.hide=function(e){this.isOpen&&(this.getElement().style.display="none",this.getElement().className=l,this.isOpen=!1)},e.prototype.getHeight=function(){return this.getElement().offsetHeight},e.prototype.getWidth=function(){return this.getElement().offsetWidth},e.prototype.destroy=function(){this.isOpen=!1,this.$element&&this.$element.parentNode&&this.$element.parentNode.removeChild(this.$element)},e}(),h=function(){function e(){this.popups=[]}return e.prototype.addPopup=function(e){this.popups.push(e),this.updatePopups()},e.prototype.removePopup=function(e){var t=this.popups.indexOf(e);-1!==t&&(this.popups.splice(t,1),this.updatePopups())},e.prototype.updatePopups=function(){var e,t,n,i
this.popups.sort((function(e,t){return t.priority-e.priority}))
var r=[]
try{for(var s=o(this.popups),a=s.next();!a.done;a=s.next()){var l=a.value,c=!0
try{for(var h=(n=void 0,o(r)),u=h.next();!u.done;u=h.next()){var g=u.value
if(this.doPopupsOverlap(g,l)){c=!1
break}}}catch(d){n={error:d}}finally{try{u&&!u.done&&(i=h.return)&&i.call(h)}finally{if(n)throw n.error}}c?r.push(l):l.hide()}}catch(p){e={error:p}}finally{try{a&&!a.done&&(t=s.return)&&t.call(s)}finally{if(e)throw e.error}}},e.prototype.doPopupsOverlap=function(e,t){var n=e.getElement().getBoundingClientRect(),i=t.getElement().getBoundingClientRect()
return n.left<i.right&&n.right>i.left&&n.top<i.bottom&&n.bottom>i.top},e}(),u=new h
t.popupManager=u,t.Tooltip=c
var d=function(e){function t(t){void 0===t&&(t=document.body)
...
if(this.isOpen){var i=this.lastEvent&&this.lastEvent.getDocumentPosition();(!this.range||!this.range.contains(i.row,i.column)||n||this.isOutsideOfText(this.lastEvent))&&this.hide()}this.timeout||n||(this.lastEvent=e,this.timeout=setTimeout(this.waitForHover,this.idleTime))},t.prototype.waitForHover=function(){this.timeout&&clearTimeout(this.timeout)
...
this.isOpen||(u.addPopup(this),this.$registerCloseEvents(),this.setTheme(o.theme)),this.isOpen=!0,this.addMarker(t,e.session),this.range=s.fromPoints(t.start,t.end)
var r=o.textToScreenCoordinates(t.start.row,t.start.column),a=o.scroller.getBoundingClientRect()
r.pageX<a.left&&(r.pageX=a.left)
var l=this.getElement()
l.innerHTML="",l.appendChild(n),l.style.maxHeight="",l.style.display="block"
var c=l.clientHeight,h=l.clientWidth,d=window.innerHeight-r.pageY-o.lineHeight,g=!0
r.pageY-c<0&&r.pageY<d&&(g=!1),l.style.maxHeight=(g?r.pageY:d)-10+"px",l.style.top=g?"":r.pageY+o.lineHeight+"px",l.style.bottom=g?window.innerHeight-r.pageY+"px":"",l.style.left=Math.min(r.pageX,window.innerWidth-h-10)+"px"}},t.prototype.addMarker=function(e,t){this.marker&&this.$markerSession.removeMarker(this.marker),this.$markerSession=t,this.marker=t&&t.addMarker(e,"ace_highlight-marker","text")},t.prototype.hide=function(e){(e||document.activeElement!=this.getElement())&&(e&&e.target&&("keydown"!=e.type||e.ctrlKey||e.metaKey)&&this.$element.contains(e.target)||(this.lastEvent=null,this.timeout&&clearTimeout(this.timeout),this.timeout=null,this.addMarker(null),this.isOpen&&(this.$removeCloseEvents(),this.getElement().style.display="none",this.isOpen=!1,u.removePopup(this))))},t.prototype.$registerCloseEvents=function(){window.addEventListener("keydown",this.hide,!0),window.addEventListener("wheel",this.hide,!0),window.addEventListener("mousedown",this.hide,!0)},t.prototype.$removeCloseEvents=function(){window.removeEventListener("keydown",this.hide,!0),window.removeEventListener("wheel",this.hide,!0),window.removeEventListener("mousedown",this.hide,!0)},t.prototype.onMouseOut=function(e){this.timeout&&(clearTimeout(this.timeout),this.timeout=null),this.lastEvent=null,this.isOpen&&e.relatedTarget&&!this.getElement().contains(e.relatedTarget)&&(e&&e.currentTarget.contains(e.relatedTarget)||e.relatedTarget.classList.contains("ace_content")||this.hide())},t}(c)
t.HoverTooltip=d})),ace.define("ace/mouse/default_gutter_handler",["require","exports","module","ace/lib/dom","ace/lib/event","ace/tooltip","ace/config","ace/lib/lang"],(function(e,t,n){"use strict"
var i=this&&this.__extends||function(){var e=function(t,n){return e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])},e(t,n)}
return function(t,n){function i(){this.constructor=t}if("function"!=typeof n&&null!==n)throw new TypeError("Class extends value "+String(n)+" is not a constructor or null")
e(t,n),t.prototype=null===n?Object.create(n):(i.prototype=n.prototype,new i)}}(),o=this&&this.__values||function(e){var t="function"==typeof Symbol&&Symbol.iterator,n=t&&e[t],i=0
if(n)return n.call(e)
if(e&&"number"==typeof e.length)return{next:function(){return e&&i>=e.length&&(e=void 0),{value:e&&e[i++],done:!e}}}
throw new TypeError(t?"Object is not iterable.":"Symbol.iterator is not defined.")},r=e("../lib/dom"),s=e("../lib/event"),a=e("../tooltip").Tooltip,l=e("../config").nls
e("../lib/lang")
t.GutterHandler=function(e){function t(){var t=a.getDocumentPosition().row
if(t==l.session.getLength()){var o=l.renderer.pixelToScreenCoordinates(0,a.y).row,r=a.$pos
if(o>l.session.documentToScreenRow(r.row,r.column))return n()}if(u.showTooltip(t),u.isOpen)if(l.on("mousewheel",n),e.$tooltipFollowsMouse)i(a)
else{var s=a.getGutterRow(),c=h.$lines.get(s)
if(c){var d=c.element.querySelector(".ace_gutter_annotation").getBoundingClientRect(),g=u.getElement().style
g.left=d.right+"px",g.top=d.bottom+"px"}else i(a)}}function n(){o&&(o=clearTimeout(o)),u.isOpen&&(u.hideTooltip(),l.off("mousewheel",n))}function i(e){u.setPosition(e.x,e.y)}var o,a,l=e.editor,h=l.renderer.$gutterLayer,u=new c(l)
e.editor.setDefaultHandler("guttermousedown",(function(t){if(l.isFocused()&&0==t.getButton()&&"foldWidgets"!=h.getRegion(t)){var n=t.getDocumentPosition().row,i=l.session.selection
if(t.getShiftKey())i.selectTo(n,0)
else{if(2==t.domEvent.detail)return l.selectAll(),t.preventDefault()
e.$clickSelection=l.selection.getLineRange(n)}return e.setState("selectByLines"),e.captureMouse(t),t.preventDefault()}})),e.editor.setDefaultHandler("guttermousemove",(function(s){var l=s.domEvent.target||s.domEvent.srcElement
if(r.hasCssClass(l,"ace_fold-widget"))return n()
u.isOpen&&e.$tooltipFollowsMouse&&i(s),a=s,o||(o=setTimeout((function(){o=null,a&&!e.isMousePressed?t():n()}),50))})),s.addListener(l.renderer.$gutter,"mouseout",(function(e){a=null,u.isOpen&&!o&&(o=setTimeout((function(){o=null,n()}),50))}),l),l.on("changeSession",n),l.on("input",n)}
var c=function(e){function t(t){var n=e.call(this,t.container)||this
return n.editor=t,n.visibleTooltipRow,n}return i(t,e),t.prototype.setPosition=function(e,t){var n=window.innerWidth||document.documentElement.clientWidth,i=window.innerHeight||document.documentElement.clientHeight,o=this.getWidth(),r=this.getHeight();(e+=15)+o>n&&(e-=e+o-n),(t+=15)+r>i&&(t-=20+r),a.prototype.setPosition.call(this,e,t)},Object.defineProperty(t,"annotationLabels",{get:function(){return{error:{singular:l("gutter-tooltip.aria-label.error.singular","error"),plural:l("gutter-tooltip.aria-label.error.plural","errors")},security:{singular:l("gutter-tooltip.aria-label.security.singular","security finding"),plural:l("gutter-tooltip.aria-label.security.plural","security findings")},warning:{singular:l("gutter-tooltip.aria-label.warning.singular","warning"),plural:l("gutter-tooltip.aria-label.warning.plural","warnings")},info:{singular:l("gutter-tooltip.aria-label.info.singular","information message"),plural:l("gutter-tooltip.aria-label.info.plural","information messages")},hint:{singular:l("gutter-tooltip.aria-label.hint.singular","suggestion"),plural:l("gutter-tooltip.aria-label.hint.plural","suggestions")}}},enumerable:!1,configurable:!0}),t.prototype.showTooltip=function(e){var n,i,o=this.editor.renderer.$gutterLayer,s=o.$annotations[e]
i=s?{displayText:Array.from(s.displayText),type:Array.from(s.type)}:{displayText:[],type:[]}
var a=o.session.getFoldLine(e)
if(a&&o.$showFoldedAnnotations){for(var l,c={error:[],security:[],warning:[],info:[],hint:[]},h={error:1,security:2,warning:3,info:4,hint:5},u=e+1;u<=a.end.row;u++)if(o.$annotations[u])for(var d=0;d<o.$annotations[u].text.length;d++){var g=o.$annotations[u].type[d]
c[g].push(o.$annotations[u].text[d]),(!l||h[g]<h[l])&&(l=g)}if(["error","security","warning"].includes(l)){var p="".concat(t.annotationsToSummaryString(c)," in folded code.")
i.displayText.push(p),i.type.push(l+"_fold")}}if(0===i.displayText.length)return this.hideTooltip()
var f={error:[],security:[],warning:[],info:[],hint:[]},m=o.$useSvgGutterIcons?"ace_icon_svg":"ace_icon"
for(u=0;u<i.displayText.length;u++){var y=r.createElement("span"),v=r.createElement("span");(n=v.classList).add.apply(n,["ace_".concat(i.type[u]),m]),v.setAttribute("aria-label","".concat(t.annotationLabels[i.type[u].replace("_fold","")].singular)),v.setAttribute("role","img"),v.appendChild(r.createTextNode(" ")),y.appendChild(v),y.appendChild(r.createTextNode(i.displayText[u])),y.appendChild(r.createElement("br")),f[i.type[u].replace("_fold","")].push(y)}var w=this.getElement()
r.removeChildren(w),f.error.forEach((function(e){return w.appendChild(e)})),f.security.forEach((function(e){return w.appendChild(e)})),f.warning.forEach((function(e){return w.appendChild(e)})),f.info.forEach((function(e){return w.appendChild(e)})),f.hint.forEach((function(e){return w.appendChild(e)})),w.setAttribute("aria-live","polite"),this.isOpen||(this.setTheme(this.editor.renderer.theme),this.setClassName("ace_gutter-tooltip")),this.show(),this.visibleTooltipRow=e,this.editor._signal("showGutterTooltip",this)},t.prototype.hideTooltip=function(){this.isOpen&&(this.$element.removeAttribute("aria-live"),this.hide(),this.visibleTooltipRow=void 0,this.editor._signal("hideGutterTooltip",this))},t.annotationsToSummaryString=function(e){var n,i,r=[]
try{for(var s=o(["error","security","warning","info","hint"]),a=s.next();!a.done;a=s.next()){var l=a.value
if(e[l].length){var h=1===e[l].length?t.annotationLabels[l].singular:t.annotationLabels[l].plural
r.push("".concat(e[l].length," ").concat(h))}}}catch(c){n={error:c}}finally{try{a&&!a.done&&(i=s.return)&&i.call(s)}finally{if(n)throw n.error}}return r.join(", ")},t}(a)
t.GutterTooltip=c})),ace.define("ace/mouse/mouse_event",["require","exports","module","ace/lib/event","ace/lib/useragent"],(function(e,t,n){"use strict"
var i=e("../lib/event"),o=e("../lib/useragent"),r=function(){function e(e,t){this.speed,this.wheelX,this.wheelY,this.domEvent=e,this.editor=t,this.x=this.clientX=e.clientX,this.y=this.clientY=e.clientY,this.$pos=null,this.$inSelection=null,this.propagationStopped=!1,this.defaultPrevented=!1}return e.prototype.stopPropagation=function(){i.stopPropagation(this.domEvent),this.propagationStopped=!0},e.prototype.preventDefault=function(){i.preventDefault(this.domEvent),this.defaultPrevented=!0},e.prototype.stop=function(){this.stopPropagation(),this.preventDefault()},e.prototype.getDocumentPosition=function(){return this.$pos||(this.$pos=this.editor.renderer.screenToTextCoordinates(this.clientX,this.clientY)),this.$pos},e.prototype.getGutterRow=function(){var e=this.getDocumentPosition().row
return this.editor.session.documentToScreenRow(e,0)-this.editor.session.documentToScreenRow(this.editor.renderer.$gutterLayer.$lines.get(0).row,0)},e.prototype.inSelection=function(){if(null!==this.$inSelection)return this.$inSelection
...
function i(e){function t(){var e=$;(function(e,t){var n=Date.now(),i=!t||e.row!=t.row,r=!t||e.column!=t.column
!A||i||r?(p.moveCursorToPosition(e),A=n,M={x:y,y:v}):o(M.x,M.y,y,v)>h?A=null:n-A>=c&&(p.renderer.scrollCursorIntoView(),A=null)})($=p.renderer.screenToTextCoordinates(y,v),e),function(e,t){var n=Date.now(),i=p.renderer.layerConfig.lineHeight,o=p.renderer.layerConfig.characterWidth,r=p.renderer.scroller.getBoundingClientRect(),s={x:{left:y-r.left,right:r.right-y},y:{top:v-r.top,bottom:r.bottom-v}},a=Math.min(s.x.left,s.x.right),c=Math.min(s.y.top,s.y.bottom),h={row:e.row,column:e.column}
...
u||d&&!g?x?n-x>=l&&p.renderer.scrollCursorIntoView(h):x=n:x=null}($,e)}function n(){b=p.selection.toOrientedRange(),m=p.session.addMarker(b,"ace_selection",p.getSelectionStyle()),p.clearSelection(),p.isFocused()&&p.renderer.$cursorLayer.setBlinking(!1),clearInterval(w),t(),w=setInterval(t,20),L=0,s.addListener(document,"mousemove",u)}function i(){clearInterval(w),p.session.removeMarker(m),m=null,p.selection.fromOrientedRange(b),p.isFocused()&&!S&&p.$resetCursorStyle(),b=null,$=null,L=0,x=null,A=null,s.removeListener(document,"mousemove",u)}function u(){null==T&&(T=setTimeout((function(){null!=T&&m&&i()}),20))}function d(e){var t=e.types
return!t||Array.prototype.some.call(t,(function(e){return"text/plain"==e||"Text"==e}))}function g(e){var t=["copy","copymove","all","uninitialized"],n=a.isMac?e.altKey:e.ctrlKey,i="uninitialized"
try{i=e.dataTransfer.effectAllowed.toLowerCase()}catch(e){}var o="none"
return n&&t.indexOf(i)>=0?o="copy":["move","copymove","linkmove","all","uninitialized"].indexOf(i)>=0?o="move":t.indexOf(i)>=0&&(o="copy"),o}var p=e.editor,f=r.createElement("div")
f.style.cssText="top:-100px;position:absolute;z-index:2147483647;opacity:0.5",f.textContent=" ";["dragWait","dragWaitEnd","startDrag","dragReadyEnd","onMouseDrag"].forEach((function(t){e[t]=this[t]}),this),p.on("mousedown",this.onMouseDown.bind(e))
var m,y,v,w,b,$,C,S,x,A,M,k=p.container,L=0
...
n.effectAllowed=p.getReadOnly()?"copy":"copyMove",p.container.appendChild(f),n.setDragImage&&n.setDragImage(f,0,0),setTimeout((function(){p.container.removeChild(f)})),n.clearData(),n.setData("Text",p.session.getTextRange()),S=!0,this.setState("drag")},this.onDragEnd=function(e){if(k.draggable=!1,S=!1,this.setState(null),!p.getReadOnly()){var t=e.dataTransfer.dropEffect
!C&&"move"==t&&p.session.remove(p.getSelectionRange()),p.$resetCursorStyle()}this.editor.unsetStyle("ace_dragging"),this.editor.renderer.setCursorStyle("")},this.onDragEnter=function(e){if(!p.getReadOnly()&&d(e.dataTransfer))return y=e.clientX,v=e.clientY,m||n(),L++,e.dataTransfer.dropEffect=C=g(e),s.preventDefault(e)},this.onDragOver=function(e){if(!p.getReadOnly()&&d(e.dataTransfer))return y=e.clientX,v=e.clientY,m||(n(),L++),null!==T&&(T=null),e.dataTransfer.dropEffect=C=g(e),s.preventDefault(e)},this.onDragLeave=function(e){if(--L<=0&&m)return i(),C=null,s.preventDefault(e)},this.onDrop=function(e){if($){var t=e.dataTransfer
if(S)switch(C){case"move":b=b.contains($.row,$.column)?{start:$,end:$}:p.moveText(b,$)
break
case"copy":b=p.moveText(b,$,!0)}else{var n=t.getData("Text")
b={start:$,end:p.session.insert($,n)},p.focus(),C=null}return i(),s.preventDefault(e)}},s.addListener(k,"dragstart",this.onDragStart.bind(e),p),s.addListener(k,"dragend",this.onDragEnd.bind(e),p),s.addListener(k,"dragenter",this.onDragEnter.bind(e),p),s.addListener(k,"dragover",this.onDragOver.bind(e),p),s.addListener(k,"dragleave",this.onDragLeave.bind(e),p),s.addListener(k,"drop",this.onDrop.bind(e),p)
var T=null}function o(e,t,n,i){return Math.sqrt(Math.pow(n-e,2)+Math.pow(i-t,2))}var r=e("../lib/dom"),s=e("../lib/event"),a=e("../lib/useragent"),l=200,c=200,h=5;(function(){this.dragWait=function(){Date.now()-this.mousedownEvent.time>this.editor.getDragDelay()&&this.startDrag()},this.dragWaitEnd=function(){this.editor.container.draggable=!1,this.startSelect(this.mousedownEvent.getDocumentPosition()),this.selectEnd()},this.dragReadyEnd=function(e){this.editor.$resetCursorStyle(),this.editor.unsetStyle("ace_dragging"),this.editor.renderer.setCursorStyle(""),this.dragWaitEnd()},this.startDrag=function(){this.cancelDrag=!1
var e=this.editor
...
"dragWait"===this.state&&(o(this.mousedownEvent.x,this.mousedownEvent.y,this.x,this.y)>0&&(t.draggable=!1,this.startSelect(this.mousedownEvent.getDocumentPosition())))},this.onMouseDown=function(e){if(this.$dragEnabled){this.mousedownEvent=e
...
if("unselectable"in o&&(o.unselectable="on"),t.getDragDelay()){if(a.isWebKit)this.cancelDrag=!0,t.container.draggable=!0
this.setState("dragWait")}else this.startDrag()
this.captureMouse(e,this.onMouseDrag.bind(this)),e.defaultPrevented=!0}}}}).call(i.prototype),t.DragdropHandler=i})),ace.define("ace/mouse/touch_handler",["require","exports","module","ace/mouse/mouse_event","ace/lib/event","ace/lib/dom"],(function(e,t,n){"use strict"
var i=e("./mouse_event").MouseEvent,o=e("../lib/event"),r=e("../lib/dom")
t.addTouchListeners=function(e,t){function n(){var e=window.navigator&&window.navigator.clipboard,n=!1,i=function(){var i=t.getCopyText(),s=t.session.getUndoManager().hasUndo()
y.replaceChild(r.buildDom(n?["span",!i&&o("selectall")&&["span",{class:"ace_mobile-button",action:"selectall"},"Select All"],i&&o("copy")&&["span",{class:"ace_mobile-button",action:"copy"},"Copy"],i&&o("cut")&&["span",{class:"ace_mobile-button",action:"cut"},"Cut"],e&&o("paste")&&["span",{class:"ace_mobile-button",action:"paste"},"Paste"],s&&o("undo")&&["span",{class:"ace_mobile-button",action:"undo"},"Undo"],o("find")&&["span",{class:"ace_mobile-button",action:"find"},"Find"],o("openCommandPalette")&&["span",{class:"ace_mobile-button",action:"openCommandPalette"},"Palette"]]:["span"]),y.firstChild)},o=function(e){return t.commands.canExecute(e,t)},s=function(o){var r=o.target.getAttribute("action")
if("more"==r||!n)return n=!n,i()
"paste"==r?e.readText().then((function(e){t.execCommand(r,e)})):r&&("cut"!=r&&"copy"!=r||(e?e.writeText(t.getCopyText()):document.execCommand("copy")),t.execCommand(r)),y.firstChild.style.display="none",n=!1,"openCommandPalette"!=r&&t.focus()}
y=r.buildDom(["div",{class:"ace_mobile-menu",ontouchstart:function(e){v="menu",e.stopPropagation(),e.preventDefault(),t.textInput.focus()},ontouchend:function(e){e.stopPropagation(),e.preventDefault(),s(e)},onclick:s},["span"],["span",{class:"ace_mobile-button",action:"more"},"..."]],t.container)}function s(){if(t.getOption("enableMobileMenu")){y||n()
var e=t.selection.cursor,i=t.renderer.textToScreenCoordinates(e.row,e.column),o=t.renderer.textToScreenCoordinates(0,0).pageX,r=t.renderer.scrollLeft,s=t.container.getBoundingClientRect()
y.style.top=i.pageY-s.top-3+"px",i.pageX-s.left<s.width-70?(y.style.left="",y.style.right="10px"):(y.style.right="",y.style.left=o+r-s.left+"px"),y.style.display="",y.firstChild.style.display="none",t.on("input",a)}else y&&a()}function a(e){y&&(y.style.display="none"),t.off("input",a)}function l(){g=null,clearTimeout(g)
var e=t.selection.getRange(),n=e.contains(f.row,f.column)
!e.isEmpty()&&n||(t.selection.moveToPosition(f),t.selection.selectWord()),v="wait",s()}var c,h,u,d,g,p,f,m,y,v="scroll",w=0,b=0,$=0,C=0
o.addListener(e,"contextmenu",(function(e){m&&t.textInput.getElement().focus()}),t),o.addListener(e,"touchstart",(function(e){var n=e.touches
if(g||n.length>1)return clearTimeout(g),g=null,u=-1,void(v="zoom")
m=t.$mouseHandler.isMousePressed=!0
var o=t.renderer.layerConfig.lineHeight,r=t.renderer.layerConfig.lineHeight,s=e.timeStamp
d=s
var a=n[0],p=a.clientX,y=a.clientY
Math.abs(c-p)+Math.abs(h-y)>o&&(u=-1),c=e.clientX=p,h=e.clientY=y,$=C=0
var S=new i(e,t)
if(f=S.getDocumentPosition(),s-u<500&&1==n.length&&!w)b++,e.preventDefault(),e.button=0,function(){g=null,clearTimeout(g),t.selection.moveToPosition(f)
var e=b>=2?t.selection.getLineRange(f.row):t.session.getBracketRange(f)
e&&!e.isEmpty()?t.selection.setRange(e):t.selection.selectWord(),v="wait"}()
else{b=0
var x=t.selection.cursor,A=t.selection.isEmpty()?x:t.selection.anchor,M=t.renderer.$cursorLayer.getPixelPosition(x,!0),k=t.renderer.$cursorLayer.getPixelPosition(A,!0),L=t.renderer.scroller.getBoundingClientRect(),T=t.renderer.layerConfig.offset,E=t.renderer.scrollLeft,R=function(e,t){return(e/=r)*e+(t=t/o-.75)*t}
if(e.clientX<L.left)return void(v="zoom")
var _=R(e.clientX-L.left-M.left+E,e.clientY-L.top-M.top+T),I=R(e.clientX-L.left-k.left+E,e.clientY-L.top-k.top+T)
_<3.5&&I<3.5&&(v=_>I?"cursor":"anchor"),v=I<3.5?"anchor":_<3.5?"cursor":"scroll",g=setTimeout(l,450)}u=s}),t),o.addListener(e,"touchend",(function(e){m=t.$mouseHandler.isMousePressed=!1,p&&clearInterval(p),"zoom"==v?(v="",w=0):g?(t.selection.moveToPosition(f),w=0,s()):"scroll"==v?(w+=60,p=setInterval((function(){w--<=0&&(clearInterval(p),p=null),Math.abs($)<.01&&($=0),Math.abs(C)<.01&&(C=0),w<20&&($*=.9),w<20&&(C*=.9)
var e=t.session.getScrollTop()
t.renderer.scrollBy(10*$,10*C),e==t.session.getScrollTop()&&(w=0)}),10),a()):s(),clearTimeout(g),g=null}),t),o.addListener(e,"touchmove",(function(e){g&&(clearTimeout(g),g=null)
var n=e.touches
if(!(n.length>1||"zoom"==v)){var o=n[0],r=c-o.clientX,s=h-o.clientY
if("wait"==v){if(!(r*r+s*s>4))return e.preventDefault()
v="cursor"}c=o.clientX,h=o.clientY,e.clientX=o.clientX,e.clientY=o.clientY
var a=e.timeStamp,l=a-d
if(d=a,"scroll"==v){var u=new i(e,t)
u.speed=1,u.wheelX=r,u.wheelY=s,10*Math.abs(r)<Math.abs(s)&&(r=0),10*Math.abs(s)<Math.abs(r)&&(s=0),0!=l&&($=r/l,C=s/l),t._emit("mousewheel",u),u.propagationStopped||($=C=0)}else{var p=new i(e,t).getDocumentPosition()
"cursor"==v?t.selection.moveCursorToPosition(p):"anchor"==v&&t.selection.setSelectionAnchor(p.row,p.column),t.renderer.scrollCursorIntoView(p),e.preventDefault()}}}),t)}})),ace.define("ace/mouse/mouse_handler",["require","exports","module","ace/lib/event","ace/lib/useragent","ace/mouse/default_handlers","ace/mouse/default_gutter_handler","ace/mouse/mouse_event","ace/mouse/dragdrop_handler","ace/mouse/touch_handler","ace/config"],(function(e,t,n){"use strict"
var i=e("../lib/event"),o=e("../lib/useragent"),r=e("./default_handlers").DefaultHandlers,s=e("./default_gutter_handler").GutterHandler,a=e("./mouse_event").MouseEvent,l=e("./dragdrop_handler").DragdropHandler,c=e("./touch_handler").addTouchListeners,h=e("../config"),u=function(){function e(e){this.$dragDelay,this.$dragEnabled,this.$mouseMoved,this.mouseEvent,this.$focusTimeout
var t=this
...
var i=e("../lib/dom"),o=function(e){e.on("click",(function(t){var n=t.getDocumentPosition(),o=e.session,r=o.getFoldAt(n.row,n.column,1)
...
s?i.removeFold(s):(i.addFold("...",r),e.renderer.scrollCursorIntoView({row:r.start.row,column:0}))}t.stop()}}))}
t.FoldHandler=o})),ace.define("ace/keyboard/keybinding",["require","exports","module","ace/lib/keys","ace/lib/event"],(function(e,t,n){"use strict"
...
function i(e,t,n,i){var o=a?g:d,p=null,f=null,m=null,y=0,v=null,w=-1,C=null,x=null,A=[]
if(!i)for(C=0,i=[];C<n;C++)i[C]=s(e[C])
for(l=a,c=!1,h=!1,u=!1,x=0;x<n;x++){if(p=y,A[x]=f=r(e,i,A,x),v=240&(y=o[p][f]),y&=15,t[x]=m=o[y][5],v>0)if(16==v){for(C=w;C<x;C++)t[C]=1
w=-1}else w=-1
if(o[y][6])-1==w&&(w=x)
else if(w>-1){for(C=w;C<x;C++)t[C]=m
w=-1}i[x]==b&&(t[x]=0),l|=m}if(u)for(C=0;C<n;C++)if(i[C]==$){t[C]=a
for(var M=C-1;M>=0&&i[M]==S;M--)t[M]=a}}function o(e,t,n){if(!(l<e))if(1!=e||a!=p||h)for(var i,o,r,s,c=n.length,u=0;u<c;){if(t[u]>=e){for(i=u+1;i<c&&t[i]>=e;)i++
for(o=u,r=i-1;o<r;o++,r--)s=n[o],n[o]=n[r],n[r]=s
u=i}u++}else n.reverse()}function r(e,t,n,i){var o,r,s,l,d=t[i]
switch(d){case f:case m:c=!1
case w:case v:return d
case y:return c?v:y
case C:return c=!0,m
case S:return w
case x:return i<1||i+1>=t.length||(o=n[i-1])!=y&&o!=v||(r=t[i+1])!=y&&r!=v?w:(c&&(r=v),r==o?r:w)
case A:return(o=i>0?n[i-1]:b)==y&&i+1<t.length&&t[i+1]==y?y:w
case M:if(i>0&&n[i-1]==y)return y
if(c)return w
for(l=i+1,s=t.length;l<s&&t[l]==M;)l++
return l<s&&t[l]==y?y:w
case k:for(s=t.length,l=i+1;l<s&&t[l]==k;)l++
if(l<s){var g=e[i],p=g>=1425&&g<=2303||64286==g
if(o=t[l],p&&(o==m||o==C))return m}return i<1||(o=t[i-1])==b?w:n[i-1]
case b:return c=!1,h=!0,a
case $:return u=!0,w
case L:case T:case R:case _:case E:c=!1
case I:return w}}function s(e){var t=e.charCodeAt(0),n=t>>8
return 0==n?t>191?f:D[t]:5==n?/[\u0591-\u05f4]/.test(e)?m:f:6==n?/[\u0610-\u061a\u064b-\u065f\u06d6-\u06e4\u06e7-\u06ed]/.test(e)?k:/[\u0660-\u0669\u066b-\u066c]/.test(e)?v:1642==t?M:/[\u06f0-\u06f9]/.test(e)?y:C:32==n&&t<=8287?N[255&t]:254==n&&t>=65136?C:w}var a=0,l=0,c=!1,h=!1,u=!1,d=[[0,3,0,1,0,0,0],[0,3,0,1,2,2,0],[0,3,0,17,2,0,1],[0,3,5,5,4,1,0],[0,3,21,21,4,0,1],[0,3,5,5,4,2,0]],g=[[2,0,1,1,0,1,0],[2,0,1,1,0,2,0],[2,0,2,1,3,2,0],[2,0,2,33,3,1,1]],p=1,f=0,m=1,y=2,v=3,w=4,b=5,$=6,C=7,S=8,x=9,A=10,M=11,k=12,L=13,T=14,E=15,R=16,_=17,I=18,D=[I,I,I,I,I,I,I,I,I,$,b,$,S,b,I,I,I,I,I,I,I,I,I,I,I,I,I,I,b,b,b,$,S,w,w,M,M,M,w,w,w,w,w,A,x,A,x,x,y,y,y,y,y,y,y,y,y,y,x,w,w,w,w,w,w,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,w,w,w,w,w,w,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,w,w,w,w,I,I,I,I,I,I,b,I,I,I,I,I,I,I,I,I,I,I,I,I,I,I,I,I,I,I,I,I,I,I,I,I,I,x,w,M,M,M,M,w,w,w,w,f,w,w,I,w,w,M,M,y,y,w,f,w,w,w,y,f,w,w,w,w,w],N=[S,S,S,S,S,S,S,S,S,S,S,I,I,I,f,m,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,S,b,L,T,E,R,_,x,M,M,M,M,M,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,x,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,S]
t.L=f,t.R=m,t.EN=y,t.ON_R=3,t.AN=4,t.R_H=5,t.B=6,t.RLE=7,t.DOT="·",t.doBidiReorder=function(e,n,r){if(e.length<2)return{}
var s=e.split(""),l=new Array(s.length),c=new Array(s.length),h=[]
a=r?p:0,i(s,h,s.length,n)
for(var u=0;u<l.length;l[u]=u,u++);o(2,h,l),o(1,h,l)
for(u=0;u<l.length-1;u++)n[u]===v?h[u]=t.AN:h[u]===m&&(n[u]>C&&n[u]<L||n[u]===w||n[u]===I)?h[u]=t.ON_R:u>0&&"ل"===s[u-1]&&/\u0622|\u0623|\u0625|\u0627/.test(s[u])&&(h[u-1]=h[u]=t.R_H,u++)
s[s.length-1]===t.DOT&&(h[s.length-1]=t.B),"‫"===s[0]&&(h[0]=t.RLE)
for(u=0;u<l.length;u++)c[u]=h[l[u]]
return{logicalFromVisual:l,bidiLevels:c}},t.hasBidiCharacters=function(e,t){for(var n=!1,i=0;i<e.length;i++)t[i]=s(e.charAt(i)),!n&&(t[i]==m||t[i]==C||t[i]==v)&&(n=!0)
...
var i=e("./lib/oop"),o=e("./lib/lang"),r=e("./lib/event_emitter").EventEmitter,s=e("./range").Range,a=function(){function e(e){this.session=e,this.doc=e.getDocument(),this.clearSelection(),this.cursor=this.lead=this.doc.createAnchor(0,0),this.anchor=this.doc.createAnchor(0,0),this.$silent=!1
var t=this
this.cursor.on("change",(function(e){t.$cursorChanged=!0,t.$silent||t._emit("changeCursor"),!t.$isEmpty&&!t.$silent&&t._emit("changeSelection"),!t.$keepDesiredColumnOnChange&&e.old.column!=e.value.column&&(t.$desiredColumn=null)})),this.anchor.on("change",(function(){t.$anchorChanged=!0,!t.$isEmpty&&!t.$silent&&t._emit("changeSelection")}))}return e.prototype.isEmpty=function(){return this.$isEmpty||this.anchor.row==this.lead.row&&this.anchor.column==this.lead.column},e.prototype.isMultiLine=function(){return!this.$isEmpty&&this.anchor.row!=this.cursor.row},e.prototype.getCursor=function(){return this.lead.getPosition()},e.prototype.setAnchor=function(e,t){this.$isEmpty=!1,this.anchor.setPosition(e,t)},e.prototype.getAnchor=function(){return this.$isEmpty?this.getSelectionLead():this.anchor.getPosition()},e.prototype.getSelectionLead=function(){return this.lead.getPosition()},e.prototype.isBackwards=function(){var e=this.anchor,t=this.lead
return e.row>t.row||e.row==t.row&&e.column>t.column},e.prototype.getRange=function(){var e=this.anchor,t=this.lead
return this.$isEmpty?s.fromPoints(t,t):this.isBackwards()?s.fromPoints(t,e):s.fromPoints(e,t)},e.prototype.clearSelection=function(){this.$isEmpty||(this.$isEmpty=!0,this._emit("changeSelection"))},e.prototype.selectAll=function(){this.$setSelection(0,0,Number.MAX_VALUE,Number.MAX_VALUE)},e.prototype.setRange=function(e,t){var n=t?e.end:e.start,i=t?e.start:e.end
this.$setSelection(n.row,n.column,i.row,i.column)},e.prototype.$setSelection=function(e,t,n,i){if(!this.$silent){var o=this.$isEmpty,r=this.inMultiSelectMode
this.$silent=!0,this.$cursorChanged=this.$anchorChanged=!1,this.anchor.setPosition(e,t),this.cursor.setPosition(n,i),this.$isEmpty=!s.comparePoints(this.anchor,this.cursor),this.$silent=!1,this.$cursorChanged&&this._emit("changeCursor"),(this.$cursorChanged||this.$anchorChanged||o!=this.$isEmpty||r)&&this._emit("changeSelection")}},e.prototype.$moveSelection=function(e){var t=this.lead
this.$isEmpty&&this.setSelectionAnchor(t.row,t.column),e.call(this)},e.prototype.selectTo=function(e,t){this.$moveSelection((function(){this.moveCursorTo(e,t)}))},e.prototype.selectToPosition=function(e){this.$moveSelection((function(){this.moveCursorToPosition(e)}))},e.prototype.moveTo=function(e,t){this.clearSelection(),this.moveCursorTo(e,t)},e.prototype.moveToPosition=function(e){this.clearSelection(),this.moveCursorToPosition(e)},e.prototype.selectUp=function(){this.$moveSelection(this.moveCursorUp)},e.prototype.selectDown=function(){this.$moveSelection(this.moveCursorDown)},e.prototype.selectRight=function(){this.$moveSelection(this.moveCursorRight)},e.prototype.selectLeft=function(){this.$moveSelection(this.moveCursorLeft)},e.prototype.selectLineStart=function(){this.$moveSelection(this.moveCursorLineStart)},e.prototype.selectLineEnd=function(){this.$moveSelection(this.moveCursorLineEnd)},e.prototype.selectFileEnd=function(){this.$moveSelection(this.moveCursorFileEnd)},e.prototype.selectFileStart=function(){this.$moveSelection(this.moveCursorFileStart)},e.prototype.selectWordRight=function(){this.$moveSelection(this.moveCursorWordRight)},e.prototype.selectWordLeft=function(){this.$moveSelection(this.moveCursorWordLeft)},e.prototype.getWordRange=function(e,t){if(void 0===t){var n=e||this.lead
e=n.row,t=n.column}return this.session.getWordRange(e,t)},e.prototype.selectWord=function(){this.setSelectionRange(this.getWordRange())},e.prototype.selectAWord=function(){var e=this.getCursor(),t=this.session.getAWordRange(e.row,e.column)
this.setSelectionRange(t)},e.prototype.getLineRange=function(e,t){var n,i="number"==typeof e?e:this.lead.row,o=this.session.getFoldLine(i)
return o?(i=o.start.row,n=o.end.row):n=i,!0===t?new s(i,0,n,this.session.getLine(n).length):new s(i,0,n+1,0)},e.prototype.selectLine=function(){this.setSelectionRange(this.getLineRange())},e.prototype.moveCursorUp=function(){this.moveCursorBy(-1,0)},e.prototype.moveCursorDown=function(){this.moveCursorBy(1,0)},e.prototype.wouldMoveIntoSoftTab=function(e,t,n){var i=e.column,o=e.column+t
return n<0&&(i=e.column-t,o=e.column),this.session.isTabStop(e)&&this.doc.getLine(e.row).slice(i,o).split(" ").length-1==t},e.prototype.moveCursorLeft=function(){var e,t=this.lead.getPosition()
...
this.wouldMoveIntoSoftTab(t,n,-1)&&!this.session.getNavigateWithinSoftTabs()?this.moveCursorBy(0,-n):this.moveCursorBy(0,-1)}},e.prototype.moveCursorRight=function(){var e,t=this.lead.getPosition()
...
t=this.lead
this.wouldMoveIntoSoftTab(t,n,1)&&!this.session.getNavigateWithinSoftTabs()?this.moveCursorBy(0,n):this.moveCursorBy(0,1)}},e.prototype.moveCursorLineStart=function(){var e=this.lead.row,t=this.lead.column,n=this.session.documentToScreenRow(e,t),i=this.session.screenToDocumentPosition(n,0),o=this.session.getDisplayLine(e,null,i.row,i.column).match(/^\s*/)
o[0].length!=t&&!this.session.$useEmacsStyleLineStart&&(i.column+=o[0].length),this.moveCursorToPosition(i)},e.prototype.moveCursorLineEnd=function(){var e=this.lead,t=this.session.getDocumentLastRowColumnPosition(e.row,e.column)
if(this.lead.column==t.column){var n=this.session.getLine(t.row)
if(t.column==n.length){var i=n.search(/\s+$/)
i>0&&(t.column=i)}}this.moveCursorTo(t.row,t.column)},e.prototype.moveCursorFileEnd=function(){var e=this.doc.getLength()-1,t=this.doc.getLine(e).length
this.moveCursorTo(e,t)},e.prototype.moveCursorFileStart=function(){this.moveCursorTo(0,0)},e.prototype.moveCursorLongWordRight=function(){var e=this.lead.row,t=this.lead.column,n=this.doc.getLine(e),i=n.substring(t)
...
this.session.tokenRe.exec(i)&&(t+=this.session.tokenRe.lastIndex,this.session.tokenRe.lastIndex=0),this.moveCursorTo(e,t)}},e.prototype.moveCursorLongWordLeft=function(){var e,t=this.lead.row,n=this.lead.column
...
this.session.tokenRe.exec(r)&&(n-=this.session.tokenRe.lastIndex,this.session.tokenRe.lastIndex=0),this.moveCursorTo(t,n)}},e.prototype.$shortWordEndIndex=function(e){var t,n=0,i=/\s/,o=this.session.tokenRe
...
if(n>2)break}}return o.lastIndex=0,n},e.prototype.moveCursorShortWordRight=function(){var e=this.lead.row,t=this.lead.column,n=this.doc.getLine(e),i=n.substring(t),o=this.session.getFoldAt(e,t,1)
...
this.moveCursorTo(e,t+s)},e.prototype.moveCursorShortWordLeft=function(){var e,t=this.lead.row,n=this.lead.column
...
return this.moveCursorTo(t,n-s)},e.prototype.moveCursorWordRight=function(){this.session.$selectLongWords?this.moveCursorLongWordRight():this.moveCursorShortWordRight()},e.prototype.moveCursorWordLeft=function(){this.session.$selectLongWords?this.moveCursorLongWordLeft():this.moveCursorShortWordLeft()},e.prototype.moveCursorBy=function(e,t){var n,i=this.session.documentToScreenPosition(this.lead.row,this.lead.column)
...
0!==e&&0===t&&r.row===this.lead.row&&(r.column,this.lead.column),this.moveCursorTo(r.row,r.column+t,0===t)},e.prototype.moveCursorToPosition=function(e){this.moveCursorTo(e.row,e.column)},e.prototype.moveCursorTo=function(e,t,n){var i=this.session.getFoldAt(e,t,1)
i&&(e=i.start.row,t=i.start.column),this.$keepDesiredColumnOnChange=!0
var o=this.session.getLine(e);/[\uDC00-\uDFFF]/.test(o.charAt(t))&&o.charAt(t-1)&&(this.lead.row==e&&this.lead.column==t+1?t-=1:t+=1),this.lead.setPosition(e,t),this.$keepDesiredColumnOnChange=!1,n||(this.$desiredColumn=null)},e.prototype.moveCursorToScreen=function(e,t,n){var i=this.session.screenToDocumentPosition(e,t)
this.moveCursorTo(i.row,i.column,n)},e.prototype.detach=function(){this.lead.detach(),this.anchor.detach()},e.prototype.fromOrientedRange=function(e){this.setSelectionRange(e,e.cursor==e.start),this.$desiredColumn=e.desiredColumn||this.$desiredColumn},e.prototype.toOrientedRange=function(e){var t=this.getRange()
return e?(e.start.column=t.start.column,e.start.row=t.start.row,e.end.column=t.end.column,e.end.row=t.end.row):e=t,e.cursor=this.isBackwards()?e.start:e.end,e.desiredColumn=this.$desiredColumn,e},e.prototype.getRangeOfMovements=function(e){var t=this.getCursor()
try{e(this)
var n=this.getCursor()
return s.fromPoints(t,n)}catch(i){return s.fromPoints(t,t)}finally{this.moveCursorToPosition(t)}},e.prototype.toJSON=function(){if(this.rangeCount)var e=this.ranges.map((function(e){var t=e.clone()
return t.isBackwards=e.cursor==e.start,t}))
else(e=this.getRange()).isBackwards=this.isBackwards()
return e},e.prototype.fromJSON=function(e){if(null==e.start){if(this.rangeList&&e.length>1){this.toSingleRange(e[0])
for(var t=e.length;t--;){var n=s.fromPoints(e[t].start,e[t].end)
e[t].isBackwards&&(n.cursor=n.start),this.addRange(n,!0)}return}e=e[0]}this.rangeList&&this.toSingleRange(e),this.setSelectionRange(e,e.isBackwards)},e.prototype.isEqual=function(e){if((e.length||this.rangeCount)&&e.length!=this.rangeCount)return!1
...
return!0},e}()
a.prototype.setSelectionAnchor=a.prototype.setAnchor,a.prototype.getSelectionAnchor=a.prototype.getAnchor,a.prototype.setSelectionRange=a.prototype.setRange,i.implement(a.prototype,r),t.Selection=a})),ace.define("ace/tokenizer",["require","exports","module","ace/lib/report_error"],(function(e,t,n){"use strict"
var i=e("./lib/report_error").reportError,o=2e3,r=function(){function e(e){for(var t in this.splitRegex,this.states=e,this.regExps={},this.matchMappings={},this.states){for(var n=this.states[t],i=[],o=0,r=this.matchMappings[t]={defaultToken:"text"},s="g",a=[],l=0;l<n.length;l++){var c=n[l]
...
if(m-f.length>h){var y=e.substring(h,m-f.length)
d.type==g?d.value+=y:(d.type&&c.push(d),d={type:g,value:y})}for(var v=0;v<l.length-2;v++)if(void 0!==l[v+1]){g=(p=r[s[v]]).onMatch?p.onMatch(f,i,n,e):p.token,p.next&&(i="string"==typeof p.next?p.next:p.next(i,n),(r=this.states[i])||(this.reportError("state doesn't exist",i),i="start",r=this.states[i]),s=this.matchMappings[i],h=m,(a=this.regExps[i]).lastIndex=m),p.consumeLineEnd&&(h=m)
break}if(f)if("string"==typeof g)p&&!1===p.merge||d.type!==g?(d.type&&c.push(d),d={type:g,value:f}):d.value+=f
else if(g){d.type&&c.push(d),d={type:null,value:""}
for(v=0;v<g.length;v++)c.push(g[v])}if(h==e.length)break
...
r.prototype.reportError=i,t.Tokenizer=r})),ace.define("ace/mode/text_highlight_rules",["require","exports","module","ace/lib/deep_copy"],(function(e,t,n){"use strict"
var i,o=e("../lib/deep_copy").deepCopy;(function(){this.addRules=function(e,t){if(t)for(var n in e){for(var i=e[n],o=0;o<i.length;o++){var r=i[o];(r.next||r.onMatch)&&("string"==typeof r.next&&0!==r.next.indexOf(t)&&(r.next=t+r.next),r.nextState&&0!==r.nextState.indexOf(t)&&(r.nextState=t+r.nextState))}this.$rules[t+n]=i}else for(var n in e)this.$rules[n]=e[n]},this.getRules=function(){return this.$rules},this.embedRules=function(e,t,n,i,r){var s="function"==typeof e?(new e).getRules():e
...
for(a=0;a<i.length;a++)c.apply(this.$rules[i[a]],o(n))}this.$embeds||(this.$embeds=[]),this.$embeds.push(t)},this.getEmbeds=function(){return this.$embeds}
...
this.$keywordList.push(a),n&&(a=a.toLowerCase()),o[a]=t}}),this),e=null,n?function(e){return o[e.toLowerCase()]||t}:function(e){return o[e]||t}},this.getKeywords=function(){return this.$keywords}}).call((i=function(){this.$rules={start:[{token:"empty_line",regex:"^$"},{defaultToken:"text"}]}}).prototype),t.TextHighlightRules=i})),ace.define("ace/mode/behaviour",["require","exports","module"],(function(e,t,n){"use strict"
var i;(function(){this.add=function(e,t,n){switch(void 0){case this.$behaviours:this.$behaviours={}
...
this.addBehaviours(n)},this.getBehaviours=function(e){if(!e)return this.$behaviours
for(var t={},n=0;n<e.length;n++)this.$behaviours[e[n]]&&(t[e[n]]=this.$behaviours[e[n]])
return t}}).call((i=function(){this.$behaviours={}}).prototype),t.Behaviour=i})),ace.define("ace/token_iterator",["require","exports","module","ace/range"],(function(e,t,n){"use strict"
...
var i,o,r=e("../../lib/oop"),s=e("../behaviour").Behaviour,a=e("../../token_iterator").TokenIterator,l=e("../../lib/lang"),c=["text","paren.rparen","rparen","paren","punctuation.operator"],h=["text","paren.rparen","rparen","paren","punctuation.operator","comment"],u={},d={'"':'"',"'":"'"},g=function(e){var t=-1
...
i=u[t]={autoInsertedBrackets:0,autoInsertedRow:-1,autoInsertedLineEnd:"",maybeInsertedBrackets:0,maybeInsertedRow:-1,maybeInsertedLineStart:"",maybeInsertedLineEnd:""}},p=function(e,t,n,i){var o=e.end.row-e.start.row
return{text:n+t+i,selection:[0,e.start.column+1,o,e.end.column+(o?0:1)]}}
o=function(e){e=e||{},this.add("braces","insertion",(function(t,n,r,s,a){var c=r.getCursorPosition(),h=s.doc.getLine(c.row)
if("{"==a){g(r)
var u=r.getSelectionRange(),d=s.doc.getTextRange(u),f=s.getTokenAt(c.row,c.column)
if(""!==d&&"{"!==d&&r.getWrapBehavioursEnabled())return p(u,d,"{","}")
if(f&&/(?:string)\.quasi|\.xml/.test(f.type)){if([/tag\-(?:open|name)/,/attribute\-name/].some((function(e){return e.test(f.type)}))||/(string)\.quasi/.test(f.type)&&"$"!==f.value[c.column-f.start-1])return
...
var m=""
if(o.isMaybeInsertedClosing(c,h)&&(m=l.stringRepeat("}",i.maybeInsertedBrackets),o.clearMaybeInsertedClosing()),"}"===h.substring(c.column,c.column+1)){var y=s.findMatchingBracket({row:c.row,column:c.column+1},"}")
if(!y)return null
var v=this.$getIndent(s.getLine(y.row))}else{if(!m)return void o.clearMaybeInsertedClosing()
v=this.$getIndent(h)}var w=v+s.getTabString()
return{text:"\n"+w+"\n"+v+m,selection:[1,w.length,1,w.length]}}o.clearMaybeInsertedClosing()}})),this.add("braces","deletion",(function(e,t,n,o,r){var s=o.doc.getTextRange(r)
if(!r.isMultiLine()&&"{"==s){if(g(n),"}"==o.doc.getLine(r.start.row).substring(r.end.column,r.end.column+1))return r.end.column++,r
i.maybeInsertedBrackets--}})),this.add("parens","insertion",(function(e,t,n,i,r){if("("==r){g(n)
var s=n.getSelectionRange(),a=i.doc.getTextRange(s)
if(""!==a&&n.getWrapBehavioursEnabled())return p(s,a,"(",")")
if(o.isSaneInsertion(n,i))return o.recordAutoInsert(n,i,")"),{text:"()",selection:[1,1]}}else if(")"==r){g(n)
var l=n.getCursorPosition(),c=i.doc.getLine(l.row)
if(")"==c.substring(l.column,l.column+1))if(null!==i.$findOpeningBracket(")",{column:l.column+1,row:l.row})&&o.isAutoInsertedClosing(l,c,r))return o.popAutoInsertedClosing(),{text:"",selection:[1,1]}}})),this.add("parens","deletion",(function(e,t,n,i,o){var r=i.doc.getTextRange(o)
if(!o.isMultiLine()&&"("==r&&(g(n),")"==i.doc.getLine(o.start.row).substring(o.start.column+1,o.start.column+2)))return o.end.column++,o})),this.add("brackets","insertion",(function(e,t,n,i,r){if("["==r){g(n)
var s=n.getSelectionRange(),a=i.doc.getTextRange(s)
if(""!==a&&n.getWrapBehavioursEnabled())return p(s,a,"[","]")
if(o.isSaneInsertion(n,i))return o.recordAutoInsert(n,i,"]"),{text:"[]",selection:[1,1]}}else if("]"==r){g(n)
var l=n.getCursorPosition(),c=i.doc.getLine(l.row)
if("]"==c.substring(l.column,l.column+1))if(null!==i.$findOpeningBracket("]",{column:l.column+1,row:l.row})&&o.isAutoInsertedClosing(l,c,r))return o.popAutoInsertedClosing(),{text:"",selection:[1,1]}}})),this.add("brackets","deletion",(function(e,t,n,i,o){var r=i.doc.getTextRange(o)
if(!o.isMultiLine()&&"["==r&&(g(n),"]"==i.doc.getLine(o.start.row).substring(o.start.column+1,o.start.column+2)))return o.end.column++,o})),this.add("string_dquotes","insertion",(function(e,t,n,i,o){var r=i.$mode.$quotes||d
...
if(""!==l&&(1!=l.length||!r[l])&&n.getWrapBehavioursEnabled())return p(a,l,s,s)
if(!l){var c=n.getCursorPosition(),h=i.doc.getLine(c.row),u=h.substring(c.column-1,c.column),f=h.substring(c.column,c.column+1),m=i.getTokenAt(c.row,c.column),y=i.getTokenAt(c.row,c.column+1)
if("\\"==u&&m&&/escape/.test(m.type))return null
var v,w=m&&/string|escape/.test(m.type),b=!y||/string|escape/.test(y.type)
if(f==s)(v=w!==b)&&/string\.end/.test(y.type)&&(v=!1)
else{if(w&&!b)return null
if(w&&b)return null
var $=i.$mode.tokenRe
$.lastIndex=0
var C=$.test(u)
$.lastIndex=0
var S=$.test(f),x=i.$mode.$pairQuotesAfter
if(!(x&&x[s]&&x[s].test(u))&&C||S)return null
if(f&&!/[\s;,.})\]\\]/.test(f))return null
var A=h[c.column-2]
if(u==s&&(A==s||$.test(A)))return null
v=!0}return{text:v?s+s:"",selection:[1,1]}}}})),this.add("string_dquotes","deletion",(function(e,t,n,i,o){var r=i.$mode.$quotes||d,s=i.doc.getTextRange(o)
if(!o.isMultiLine()&&r.hasOwnProperty(s)&&(g(n),i.doc.getLine(o.start.row).substring(o.start.column+1,o.start.column+2)==s))return o.end.column++,o})),!1!==e.closeDocComment&&this.add("doc comment end","insertion",(function(e,t,n,i,o){if("doc-start"===e&&("\n"===o||"\r\n"===o)&&n.selection.isEmpty()){var r=n.getCursorPosition()
if(0===r.column)return
for(var s=i.doc.getLine(r.row),a=i.doc.getLine(r.row+1),l=i.getTokens(r.row),c=0,h=0;h<l.length;h++){c+=l[h].value.length
var u=l[h]
if(c>=r.column){if(c===r.column){if(!/\.doc/.test(u.type))return
if(/\*\//.test(u.value)){var d=l[h+1]
if(!d||!/\.doc/.test(d.type))return}}var g=r.column-(c-u.value.length),p=u.value.indexOf("*/"),f=u.value.indexOf("/**",p>-1?p+2:0)
if(-1!==f&&g>f&&g<f+3)return
if(-1!==p&&-1!==f&&g>=p&&g<=f||!/\.doc/.test(u.type))return
break}}var m=this.$getIndent(s)
if(/\s*\*/.test(a))return/^\s*\*/.test(s)?{text:o+m+"* ",selection:[1,2+m.length,1,2+m.length]}:{text:o+m+" * ",selection:[1,3+m.length,1,3+m.length]}
if(/\/\*\*/.test(s.substring(0,r.column)))return{text:o+m+" * "+o+" "+m+"*/",selection:[1,4+m.length,1,4+m.length]}}}))},o.isSaneInsertion=function(e,t){var n=e.getCursorPosition(),i=new a(t,n.row,n.column)
if(!this.$matchTokenType(i.getCurrentToken()||"text",c)){if(/[)}\]]/.test(e.session.getLine(n.row)[n.column]))return!0
var o=new a(t,n.row,n.column+1)
if(!this.$matchTokenType(o.getCurrentToken()||"text",c))return!1}return i.stepForward(),i.getCurrentTokenRow()!==n.row||this.$matchTokenType(i.getCurrentToken()||"text",h)},o.$matchTokenType=function(e,t){return t.indexOf(e.type||e)>-1},o.recordAutoInsert=function(e,t,n){var o=e.getCursorPosition(),r=t.doc.getLine(o.row)
this.isAutoInsertedClosing(o,r,i.autoInsertedLineEnd[0])||(i.autoInsertedBrackets=0),i.autoInsertedRow=o.row,i.autoInsertedLineEnd=n+r.substr(o.column),i.autoInsertedBrackets++},o.recordMaybeInsert=function(e,t,n){var o=e.getCursorPosition(),r=t.doc.getLine(o.row)
...
var i,o=e("../config"),r=e("../tokenizer").Tokenizer,s=e("./text_highlight_rules").TextHighlightRules,a=e("./behaviour/cstyle").CstyleBehaviour,l=e("../unicode"),c=e("../lib/lang"),h=e("../token_iterator").TokenIterator,u=e("../range").Range;(function(){this.$defaultBehaviour=new a,this.tokenRe=new RegExp("^["+l.wordChars+"\\$_]+","g"),this.nonTokenRe=new RegExp("^(?:[^"+l.wordChars+"\\$_]|\\s])+","g"),this.getTokenizer=function(){return this.$tokenizer||(this.$highlightRules=this.$highlightRules||new this.HighlightRules(this.$highlightRuleConfig),this.$tokenizer=new r(this.$highlightRules.getRules())),this.$tokenizer},this.lineCommentStart="",this.blockComment="",this.toggleCommentLines=function(e,t,n,i){function o(e){for(var t=n;t<=i;t++)e(r.getLine(t),t)}var r=t.doc,s=!0,a=!0,l=1/0,h=t.getTabSize(),u=!1
if(this.lineCommentStart){if(Array.isArray(this.lineCommentStart))m=this.lineCommentStart.map(c.escapeRegExp).join("|"),p=this.lineCommentStart[0]
else m=c.escapeRegExp(this.lineCommentStart),p=this.lineCommentStart
m=new RegExp("^(\\s*)(?:"+m+") ?"),u=t.getUseSoftTabs()
w=function(e,t){var n=e.match(m)
if(n){var i=n[1].length,o=n[0].length
!g(e,i,o)&&" "==n[0][o-1]&&o--,r.removeInLine(t,i,o)}}
var d=p+" ",g=(v=function(e,t){s&&!/\S/.test(e)||(g(e,l,l)?r.insertInLine({row:t,column:l},d):r.insertInLine({row:t,column:l},p))},b=function(e,t){return m.test(e)},function(e,t,n){for(var i=0;t--&&" "==e.charAt(t);)i++
if(i%h!=0)return!1
for(i=0;" "==e.charAt(n++);)i++
return h>2?i%h!=h-1:i%h==0})}else{if(!this.blockComment)return!1
var p=this.blockComment.start,f=this.blockComment.end,m=new RegExp("^(\\s*)(?:"+c.escapeRegExp(p)+")"),y=new RegExp("(?:"+c.escapeRegExp(f)+")\\s*$"),v=function(e,t){b(e,t)||s&&!/\S/.test(e)||(r.insertInLine({row:t,column:e.length},f),r.insertInLine({row:t,column:l},p))},w=function(e,t){var n;(n=e.match(y))&&r.removeInLine(t,e.length-n[0].length,e.length),(n=e.match(m))&&r.removeInLine(t,n[1].length,n[0].length)},b=function(e,n){if(m.test(e))return!0
for(var i=t.getTokens(n),o=0;o<i.length;o++)if("comment"===i[o].type)return!0}}var $=1/0
o((function(e,t){var n=e.search(/\S/);-1!==n?(n<l&&(l=n),a&&!b(e,t)&&(a=!1)):$>e.length&&($=e.length)})),l==1/0&&(l=$,s=!1,a=!1),u&&l%h!=0&&(l=Math.floor(l/h)*h),o(a?w:v)},this.toggleBlockComment=function(e,t,n,i){var o=this.blockComment
if(o){!o.start&&o[0]&&(o=o[0])
var r,s,a=(f=new h(t,i.row,i.column)).getCurrentToken(),l=(t.selection,t.selection.toOrientedRange())
if(a&&/comment/.test(a.type)){for(var c,d;a&&/comment/.test(a.type);){if(-1!=(m=a.value.indexOf(o.start))){var g=f.getCurrentTokenRow(),p=f.getCurrentTokenColumn()+m
c=new u(g,p,g,p+o.start.length)
break}a=f.stepBackward()}var f
for(a=(f=new h(t,i.row,i.column)).getCurrentToken();a&&/comment/.test(a.type);){var m
if(-1!=(m=a.value.indexOf(o.end))){g=f.getCurrentTokenRow(),p=f.getCurrentTokenColumn()+m
d=new u(g,p,g,p+o.end.length)
break}a=f.stepForward()}d&&t.remove(d),c&&(t.remove(c),r=c.start.row,s=-o.start.length)}else s=o.start.length,r=n.start.row,t.insert(n.end,o.end),t.insert(n.start,o.start)
l.start.row==r&&(l.start.column+=s),l.end.row==r&&(l.end.column+=s),t.selection.fromOrientedRange(l)}},this.getNextLineIndent=function(e,t,n){return this.$getIndent(t)},this.checkOutdent=function(e,t,n){return!1},this.autoOutdent=function(e,t,n){},this.$getIndent=function(e){return e.match(/^\s*/)[0]},this.createWorker=function(e){return null},this.createModeDelegates=function(e){for(var t in this.$embeds=[],this.$modes={},e)if(e[t]){var n=e[t],i=n.prototype.$id,r=o.$modes[i]
r||(o.$modes[i]=r=new n),o.$modes[t]||(o.$modes[t]=r),this.$embeds.push(t),this.$modes[t]=r}var s=["toggleBlockComment","toggleCommentLines","getNextLineIndent","checkOutdent","autoOutdent","transformAction","getCompletions"],a=function(e){(function(t){var n=s[e],i=t[n]
t[s[e]]=function(){return this.$delegator(n,arguments,i)}})(l)},l=this
for(t=0;t<s.length;t++)a(t)},this.$delegator=function(e,t,n){var i=t[0]||"start"
...
else if("object"==typeof o[r].token)for(var a=0,l=o[r].token.length;a<l;a++)if(/keyword|support|storage/.test(o[r].token[a])){i=o[r].regex.match(/\(.+?\)/g)[a]
n.push(i.substr(1,i.length-2))}this.completionKeywords=n}return e?n.concat(this.$keywordList||[]):this.$keywordList},this.$createKeywordList=function(){return this.$highlightRules||this.getTokenizer(),this.$keywordList=this.$highlightRules.$keywordList||[]},this.getCompletions=function(e,t,n,i){return(this.$keywordList||this.$createKeywordList()).map((function(e){return{name:e,value:e,score:0,meta:"keyword"}}))},this.$id="ace/mode/text"}).call((i=function(){this.HighlightRules=s}).prototype),t.Mode=i})),ace.define("ace/line_widgets",["require","exports","module","ace/lib/dom"],(function(e,t,n){"use strict"
...
if(0!==i)if("remove"==e.action){var o=t.splice(n+1,i)
...
break}n=n.$oldWidget}}this.session._emit("changeFold",{data:{start:{row:e.row}}}),this.$updateRows()},e.prototype.getWidgetsAtRow=function(e){for(var t=this.session.lineWidgets,n=t&&t[e],i=[];n;)i.push(n),n=n.$oldWidget
...
t.LineWidgets=o})),ace.define("ace/apply_delta",["require","exports","module"],(function(e,t,n){"use strict"
...
function i(e,t,n){var i=n?e.column<=t.column:e.column<t.column
return e.row<t.row||e.row==t.row&&i}var o=e("./lib/oop"),r=e("./lib/event_emitter").EventEmitter,s=function(){function e(e,t,n){this.$onChange=this.onChange.bind(this),this.attach(e),"number"!=typeof t?this.setPosition(t.row,t.column):this.setPosition(t,n)}return e.prototype.getPosition=function(){return this.$clipPositionToDocument(this.row,this.column)},e.prototype.getDocument=function(){return this.document},e.prototype.onChange=function(e){if(!(e.start.row==e.end.row&&e.start.row!=this.row||e.start.row>this.row)){var t=function(e,t,n){var o="insert"==e.action,r=(o?1:-1)*(e.end.row-e.start.row),s=(o?1:-1)*(e.end.column-e.start.column),a=e.start,l=o?a:e.end
return i(t,a,n)?{row:t.row,column:t.column}:i(l,t,!n)?{row:t.row+r,column:t.column+(t.row==l.row?s:0)}:{row:a.row,column:a.column}}(e,{row:this.row,column:this.column},this.$insertRight)
...
s.prototype.$insertRight=!1,o.implement(s.prototype,r),t.Anchor=s})),ace.define("ace/document",["require","exports","module","ace/lib/oop","ace/apply_delta","ace/lib/event_emitter","ace/range","ace/anchor"],(function(e,t,n){"use strict"
...
r.prototype.MAX_RANGES=500,t.SearchHighlight=r})),ace.define("ace/undomanager",["require","exports","module","ace/range"],(function(e,t,n){"use strict"
function i(e){return{row:e.row,column:e.column}}function o(e){if(e=e||this,Array.isArray(e))return e.map(o).join("\n")
var t=""
return e.action?(t="insert"==e.action?"+":"-",t+="["+e.lines+"]"):e.value&&(t=Array.isArray(e.value)?e.value.map(r).join("\n"):r(e.value)),e.start&&(t+=r(e)),(e.id||e.rev)&&(t+="\t("+(e.id||e.rev)+")"),t}function r(e){return e.start.row+":"+e.start.column+"=>"+e.end.row+":"+e.end.column}function s(e,t){var n="insert"==e.action,i="insert"==t.action
if(n&&i)if(f(t.start,e.end)>=0)c(t,e,-1)
else{if(!(f(t.start,e.start)<=0))return null
c(e,t,1)}else if(n&&!i)if(f(t.start,e.end)>=0)c(t,e,-1)
else{if(!(f(t.end,e.start)<=0))return null
c(e,t,-1)}else if(!n&&i)if(f(t.start,e.start)>=0)c(t,e,1)
else{if(!(f(t.start,e.start)<=0))return null
c(e,t,1)}else if(!n&&!i)if(f(t.start,e.start)>=0)c(t,e,1)
else{if(!(f(t.end,e.start)<=0))return null
c(e,t,-1)}return[t,e]}function a(e,t){for(var n=e.length;n--;)for(var i=0;i<t.length;i++)if(!s(e[n],t[i])){for(;n<e.length;){for(;i--;)s(t[i],e[n])
i=t.length,n++}return[e,t]}return e.selectionBefore=t.selectionBefore=e.selectionAfter=t.selectionAfter=null,[t,e]}function l(e,t){var n="insert"==e.action,i="insert"==t.action
if(n&&i)f(e.start,t.start)<0?c(t,e,1):c(e,t,1)
else if(n&&!i)f(e.start,t.end)>=0?c(e,t,-1):(f(e.start,t.start)<=0||c(e,p.fromPoints(t.start,e.start),-1),c(t,e,1))
else if(!n&&i)f(t.start,e.end)>=0?c(t,e,-1):(f(t.start,e.start)<=0||c(t,p.fromPoints(e.start,t.start),-1),c(e,t,1))
else if(!n&&!i)if(f(t.start,e.end)>=0)c(t,e,-1)
else{var o,r
if(!(f(t.end,e.start)<=0))return f(e.start,t.start)<0&&(o=e,e=u(e,t.start)),f(e.end,t.end)>0&&(r=u(e,t.end)),h(t.end,e.start,e.end,-1),r&&!o&&(e.lines=r.lines,e.start=r.start,e.end=r.end,r=e),[t,o,r].filter(Boolean)
c(e,t,-1)}return[t,e]}function c(e,t,n){h(e.start,t.start,t.end,n),h(e.end,t.start,t.end,n)}function h(e,t,n,i){e.row==(1==i?t:n).row&&(e.column+=i*(n.column-t.column)),e.row+=i*(n.row-t.row)}function u(e,t){var n=e.lines,o=e.end
e.end=i(t)
var r=e.end.row-e.start.row,s=n.splice(r,n.length),a=r?t.column:t.column-e.start.column
return n.push(s[0].substring(0,a)),s[0]=s[0].substr(a),{start:i(t),end:o,lines:s,action:e.action}}function d(e,t){t=function(e){return{start:i(e.start),end:i(e.end),action:e.action,lines:e.lines.slice()}}(t)
for(var n=e.length;n--;){for(var o=e[n],r=0;r<o.length;r++){var s=l(o[r],t)
t=s[0],2!=s.length&&(s[2]?(o.splice(r+1,1,s[1],s[2]),r++):s[1]||(o.splice(r,1),r--))}o.length||e.splice(n,1)}return e}var g=function(){function e(){this.$keepRedoStack,this.$maxRev=0,this.$fromUndo=!1,this.$undoDepth=1/0,this.reset()}return e.prototype.addSession=function(e){this.$session=e},e.prototype.add=function(e,t,n){if(!this.$fromUndo&&e!=this.$lastDelta){if(this.$keepRedoStack||(this.$redoStack.length=0),!1===t||!this.lastDeltas){this.lastDeltas=[]
...
if(i&&!i[0].ignore){for(;n<t-1;){var o=a(e[n],e[n+1])
...
g.prototype.hasUndo=g.prototype.canUndo,g.prototype.hasRedo=g.prototype.canRedo,g.prototype.isClean=g.prototype.isAtBookmark,g.prototype.markClean=g.prototype.bookmark
var p=e("./range").Range,f=p.comparePoints
p.comparePoints
t.UndoManager=g})),ace.define("ace/edit_session/fold_line",["require","exports","module","ace/range"],(function(e,t,n){"use strict"
...
if(t>=0)return this.ranges.splice(t,1)},e.prototype.merge=function(){var e=[],t=this.ranges
t=t.sort((function(e,t){return i(e.start,t.start)}))
for(var n,o=t[0],r=1;r<t.length;r++){n=o,o=t[r]
var s=i(n.end,o.start)
s<0||(0!=s||n.isEmpty()||o.isEmpty())&&(i(n.end,o.end)<0&&(n.end.row=o.end.row,n.end.column=o.end.column),t.splice(r,1),e.push(o),o=n,r--)}return this.ranges=t,e},e.prototype.contains=function(e,t){return this.pointIndex({row:e,column:t})>=0},e.prototype.containsPoint=function(e){return this.pointIndex(e)>=0},e.prototype.rangeAtPoint=function(e){var t=this.pointIndex(e)
...
return r},e.prototype.removeAll=function(){return this.ranges.splice(0,this.ranges.length)},e.prototype.attach=function(e){this.session&&this.detach(),this.session=e,this.onChange=this.$onChange.bind(this),this.session.on("change",this.onChange)},e.prototype.detach=function(){this.session&&(this.session.removeListener("change",this.onChange),this.session=null)},e.prototype.$onChange=function(e){for(var t=e.start,n=e.end,i=t.row,o=n.row,r=this.ranges,s=0,a=r.length;s<a;s++){if((h=r[s]).end.row>=i)break}if("insert"==e.action)for(var l=o-i,c=-t.column+n.column;s<a;s++){if((h=r[s]).start.row>i)break
if(h.start.row==i&&h.start.column>=t.column&&(h.start.column==t.column&&this.$bias<=0||(h.start.column+=c,h.start.row+=l)),h.end.row==i&&h.end.column>=t.column){if(h.end.column==t.column&&this.$bias<0)continue
h.end.column==t.column&&c>0&&s<a-1&&h.end.column>h.start.column&&h.end.column==r[s+1].start.column&&(h.end.column-=c),h.end.column+=c,h.end.row+=l}}else for(l=i-o,c=t.column-n.column;s<a;s++){if((h=r[s]).start.row>o)break
h.end.row<o&&(i<h.end.row||i==h.end.row&&t.column<h.end.column)?(h.end.row=i,h.end.column=t.column):h.end.row==o?h.end.column<=n.column?(l||h.end.column>t.column)&&(h.end.column=t.column,h.end.row=t.row):(h.end.column+=c,h.end.row+=l):h.end.row>o&&(h.end.row+=l),h.start.row<o&&(i<h.start.row||i==h.start.row&&t.column<h.start.column)?(h.start.row=i,h.start.column=t.column):h.start.row==o?h.start.column<=n.column?(l||h.start.column>t.column)&&(h.start.column=t.column,h.start.row=t.row):(h.start.column+=c,h.start.row+=l):h.start.row>o&&(h.start.row+=l)}if(0!=l&&s<a)for(;s<a;s++){var h;(h=r[s]).start.row+=l,h.end.row+=l}},e}()
...
function i(e,t){e.row-=t.row,0==e.row&&(e.column-=t.column)}function o(e,t){i(e.start,t),i(e.end,t)}function r(e,t){0==e.row&&(e.column+=t.column),e.row+=t.row}var s=this&&this.__extends||function(){var e=function(t,n){return e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])},e(t,n)}
return function(t,n){function i(){this.constructor=t}if("function"!=typeof n&&null!==n)throw new TypeError("Class extends value "+String(n)+" is not a constructor or null")
e(t,n),t.prototype=null===n?Object.create(n):(i.prototype=n.prototype,new i)}}(),a=function(e){function t(t,n){var i=e.call(this)||this
...
return this.subFolds.forEach((function(t){e.subFolds.push(t.clone())})),e.collapseChildren=this.collapseChildren,e},t.prototype.addSubFold=function(e){if(!this.range.isEqual(e)){o(e,this.start)
for(var t=e.start.row,n=e.start.column,i=0,r=-1;i<this.subFolds.length&&1==(r=this.subFolds[i].range.compare(t,n));i++);var s=this.subFolds[i],a=0
if(0==r){if(s.range.containsRange(e))return s.addSubFold(e)
a=1}t=e.range.end.row,n=e.range.end.column
var l=i
for(r=-1;l<this.subFolds.length&&1==(r=this.subFolds[l].range.compare(t,n));l++);0==r&&l++
for(var c=this.subFolds.splice(i,l-i,e),h=0==r?c.length-1:c.length,u=a;u<h;u++)e.addSubFold(c[u])
return e.setFoldLine(this.foldLine),e}},t.prototype.restoreRange=function(e){return function(e,t){r(e.start,t),r(e.end,t)}(e,this.start)},t}(e("../range_list").RangeList)
t.Fold=a})),ace.define("ace/edit_session/folding",["require","exports","module","ace/range","ace/edit_session/fold_line","ace/edit_session/fold","ace/token_iterator","ace/mouse/mouse_event"],(function(e,t,n){"use strict"
...
return new o(e,n)})),e},this.toggleFold=function(e){var t,n,i=this.selection.getRange()
...
if(1!=n){do{r=o.stepBackward()}while(r&&l.test(r.type))
r=o.stepForward()}c.start.row=o.getCurrentTokenRow(),c.start.column=o.getCurrentTokenColumn()+r.value.length,o=new s(this,e,t)
var h=this.getState(o.$row)
if(-1!=n){var u=-1
do{if(r=o.stepForward(),-1==u){var d=this.getState(o.$row)
h.toString()!==d.toString()&&(u=o.$row)}else if(o.$row>u)break}while(r&&l.test(r.type))
r=o.stepBackward()}else r=o.getCurrentToken()
return c.end.row=o.getCurrentTokenRow(),c.end.column=o.getCurrentTokenColumn(),c}},this.foldAll=function(e,t,n,i){null==n&&(n=1e5)
...
do{if(-1!==(n=t).type.indexOf("tag-close")&&!c){var h=new o(e.getCurrentTokenRow(),e.getCurrentTokenColumn(),e.getCurrentTokenRow(),e.getCurrentTokenColumn()+1)
c=!0}if(t=e.stepForward()){if(">"===t.value&&!c){h=new o(e.getCurrentTokenRow(),e.getCurrentTokenColumn(),e.getCurrentTokenRow(),e.getCurrentTokenColumn()+1)
...
var g=new o(e.getCurrentTokenRow(),e.getCurrentTokenColumn(),e.getCurrentTokenRow(),e.getCurrentTokenColumn()+1)}}else if(r===i&&"/>"===t.value&&--s<0)g=d=u=new o(e.getCurrentTokenRow(),e.getCurrentTokenColumn(),e.getCurrentTokenRow(),e.getCurrentTokenColumn()+2),h=new o(l.end.row,l.end.column,l.end.row,l.end.column+1)}}while(t&&s>=0)
...
if(-1===t.type.indexOf("tag-close")&&(t=e.stepForward()),t&&">"===t.value){var u=new o(e.getCurrentTokenRow(),e.getCurrentTokenColumn(),e.getCurrentTokenRow(),e.getCurrentTokenColumn()+1)
...
m=e.stepBackward(),f++}for(var y=0;y<f;y++)e.stepForward()}}while(n&&r<=0)
...
function i(e){return!(e<4352)&&(e>=4352&&e<=4447||e>=4515&&e<=4519||e>=4602&&e<=4607||e>=9001&&e<=9002||e>=11904&&e<=11929||e>=11931&&e<=12019||e>=12032&&e<=12245||e>=12272&&e<=12283||e>=12288&&e<=12350||e>=12353&&e<=12438||e>=12441&&e<=12543||e>=12549&&e<=12589||e>=12593&&e<=12686||e>=12688&&e<=12730||e>=12736&&e<=12771||e>=12784&&e<=12830||e>=12832&&e<=12871||e>=12880&&e<=13054||e>=13056&&e<=19903||e>=19968&&e<=42124||e>=42128&&e<=42182||e>=43360&&e<=43388||e>=44032&&e<=55203||e>=55216&&e<=55238||e>=55243&&e<=55291||e>=63744&&e<=64255||e>=65040&&e<=65049||e>=65072&&e<=65106||e>=65108&&e<=65126||e>=65128&&e<=65131||e>=65281&&e<=65376||e>=65504&&e<=65510)}var o=e("./lib/oop"),r=e("./lib/lang"),s=e("./bidihandler").BidiHandler,a=e("./config"),l=e("./lib/event_emitter").EventEmitter,c=e("./selection").Selection,h=e("./mode/text").Mode,u=e("./range").Range,d=e("./line_widgets").LineWidgets,g=e("./document").Document,p=e("./background_tokenizer").BackgroundTokenizer,f=e("./search_highlight").SearchHighlight,m=e("./undomanager").UndoManager,y=function(){function e(t,n){this.doc,this.$breakpoints=[],this.$decorations=[],this.$frontMarkers={},this.$backMarkers={},this.$markerId=1,this.$undoSelect=!0,this.$editor=null,this.prevOp={},this.$foldData=[],this.id="session"+ ++e.$uid,this.$foldData.toString=function(){return this.join("\n")},this.bgTokenizer=new p((new h).getTokenizer(),this)
var i=this
this.bgTokenizer.on("update",(function(e){i._signal("tokenizerUpdate",e)})),this.on("changeFold",this.onChangeFold.bind(this)),this.$onChange=this.onChange.bind(this),"object"==typeof t&&t.getLine||(t=new g(t)),this.setDocument(t),this.selection=new c(this),this.$onSelectionChange=this.onSelectionChange.bind(this),this.selection.on("changeSelection",this.$onSelectionChange),this.selection.on("changeCursor",this.$onSelectionChange),this.$bidiHandler=new s(this),a.resetOptions(this),this.setMode(n),a._signal("session",this),this.destroyed=!1,this.$initOperationListeners()}return e.prototype.$initOperationListeners=function(){var e=this
this.curOp=null,this.on("change",(function(){e.curOp||(e.startOperation(),e.curOp.selectionBefore=e.$lastSel),e.curOp.docChanged=!0}),!0),this.on("changeSelection",(function(){e.curOp||(e.startOperation(),e.curOp.selectionBefore=e.$lastSel),e.curOp.selectionChanged=!0}),!0),this.$operationResetTimer=r.delayedCall(this.endOperation.bind(this,!0))},e.prototype.startOperation=function(e){if(this.curOp){if(!e||this.curOp.command)return
this.prevOp=this.curOp}e||(e={}),this.$operationResetTimer.schedule(),this.curOp={command:e.command||{},args:e.args},this.curOp.selectionBefore=this.selection.toJSON(),this._signal("startOperation",e)},e.prototype.endOperation=function(e){if(this.curOp){if(e&&!1===e.returnValue)return this.curOp=null,void this._signal("endOperation",e)
if(1==e&&this.curOp.command&&"mouse"==this.curOp.command.name)return
var t=this.selection.toJSON()
this.curOp.selectionAfter=t,this.$lastSel=this.selection.toJSON(),this.getUndoManager().addSelection(t),this._signal("beforeEndOperation"),this.prevOp=this.curOp,this.curOp=null,this._signal("endOperation",e)}},e.prototype.setDocument=function(e){this.doc&&this.doc.off("change",this.$onChange),this.doc=e,e.on("change",this.$onChange,!0),this.bgTokenizer.setDocument(this.getDocument()),this.resetCaches()},e.prototype.getDocument=function(){return this.doc},Object.defineProperty(e.prototype,"widgetManager",{get:function(){var e=new d(this)
return this.widgetManager=e,this.$editor&&e.attach(this.$editor),e},set:function(e){Object.defineProperty(this,"widgetManager",{writable:!0,enumerable:!0,configurable:!0,value:e})},enumerable:!1,configurable:!0}),e.prototype.$resetRowCache=function(e){if(!e)return this.$docRowCache=[],void(this.$screenRowCache=[])
...
!this.$fromUndo&&this.$undoManager&&(t&&t.length&&(this.$undoManager.add({action:"removeFolds",folds:t},this.mergeUndoDeltas),this.mergeUndoDeltas=!0),this.$undoManager.add(e,this.mergeUndoDeltas),this.mergeUndoDeltas=!0,this.$informUndoManager.schedule()),this.bgTokenizer.$updateOnChange(e),this._signal("change",e)},e.prototype.onSelectionChange=function(){this._signal("changeSelection")},e.prototype.setValue=function(e){this.doc.setValue(e),this.selection.moveTo(0,0),this.$resetRowCache(0),this.setUndoManager(this.$undoManager),this.getUndoManager().reset()},e.fromJSON=function(t){"string"==typeof t&&(t=JSON.parse(t))
var n=new m
n.$undoStack=t.history.undo,n.$redoStack=t.history.redo,n.mark=t.history.mark,n.$rev=t.history.rev
var i=new e(t.value)
return t.folds.forEach((function(e){i.addFold("...",u.fromPoints(e.start,e.end))})),i.setAnnotations(t.annotations),i.setBreakpoints(t.breakpoints),i.setMode(t.mode),i.setScrollLeft(t.scrollLeft),i.setScrollTop(t.scrollTop),i.setUndoManager(n),i.selection.fromJSON(t.selection),i},e.prototype.toJSON=function(){return{annotations:this.$annotations,breakpoints:this.$breakpoints,folds:this.getAllFolds().map((function(e){return e.range})),history:this.getUndoManager(),mode:this.$mode.$id,scrollLeft:this.$scrollLeft,scrollTop:this.$scrollTop,selection:this.selection.toJSON(),value:this.doc.getValue()}},e.prototype.toString=function(){return this.doc.getValue()},e.prototype.getSelection=function(){return this.selection},e.prototype.getState=function(e){return this.bgTokenizer.getState(e)},e.prototype.getTokens=function(e){return this.bgTokenizer.getTokens(e)},e.prototype.getTokenAt=function(e,t){var n,i=this.bgTokenizer.getTokens(e),o=0
...
t&&(delete(t.inFront?this.$frontMarkers:this.$backMarkers)[e],this._signal(t.inFront?"changeFrontMarker":"changeBackMarker"))},e.prototype.getMarkers=function(e){return e?this.$frontMarkers:this.$backMarkers},e.prototype.highlight=function(e){if(!this.$searchHighlight){var t=new f(null,"ace_selected-word","text")
...
return new u(e,r,e,s)},e.prototype.getAWordRange=function(e,t){for(var n=this.getWordRange(e,t),i=this.getLine(n.end.row);i.charAt(n.end.column).match(/[ \t]/);)n.end.column+=1
...
this.$modeId=i,a.loadModule(["mode",i],function(e){if(!this.destroyed)return this.$modeId!==i?t&&t():(this.$modes[i]&&!n?this.$onChangeMode(this.$modes[i]):e&&e.Mode&&(e=new e.Mode(n),n||(this.$modes[i]=e,e.$id=i),this.$onChangeMode(e)),void(t&&t()))}.bind(this)),this.$mode||this.$onChangeMode(this.$modes["ace/mode/text"],!0)},e.prototype.$onChangeMode=function(e,t){if(t||(this.$modeId=e.$id),this.$mode!==e){var n=this.$mode
...
for(var n=0;n<e.length;n++){var i=e[n];("insert"==i.action||"remove"==i.action)&&this.doc.$safeApplyDelta(i)}!t&&this.$undoSelect&&(e.selectionAfter?this.selection.fromJSON(e.selectionAfter):this.selection.setRange(this.$getUndoSelection(e,!1))),this.$fromUndo=!1}},e.prototype.setUndoSelect=function(e){this.$undoSelect=e},e.prototype.$getUndoSelection=function(e,t){function n(e){return t?"insert"!==e.action:"insert"===e.action}for(var i,o,r=0;r<e.length;r++){var s=e[r]
s.start&&(i?n(s)?(o=s.start,-1==i.compare(o.row,o.column)&&i.setStart(o),o=s.end,1==i.compare(o.row,o.column)&&i.setEnd(o)):(o=s.start,-1==i.compare(o.row,o.column)&&(i=u.fromPoints(s.start,s.start))):i=n(s)?u.fromPoints(s.start,s.end):u.fromPoints(s.start,s.start))}return i},e.prototype.replace=function(e,t){return this.doc.replace(e,t)},e.prototype.moveText=function(e,t,n){var i=this.getTextRange(e),o=this.getFoldsInRange(e),r=u.fromPoints(t,t)
if(!n){this.remove(e)
...
for(var i=e;i<=t;i++)this.doc.insertInLine({row:i,column:0},n)},e.prototype.outdentRows=function(e){for(var t=e.collapseRows(),n=new u(0,0,0,0),i=this.getTabSize(),o=t.start.row;o<=t.end.row;++o){var r=this.getLine(o)
...
i=o-t}else{e=this.$clipRowToDocument(e)
i=(t=this.$clipRowToDocument(t))-e+1}var r=new u(e,0,t,Number.MAX_VALUE),s=this.getFoldsInRange(r).map((function(e){return(e=e.clone()).start.row+=i,e.end.row+=i,e})),a=0==n?this.doc.getLines(e,t):this.doc.removeFullLines(e,t)
...
u&&u!==f&&(u.merge(f),f=u),h=c.indexOf(f)+1}for(;h<c.length;h++){(f=c[h]).start.row>=o.row&&f.shiftRow(-a)}s=r}else{var d=Array(a)
d.unshift(r,0)
var g=t?this.$wrapData:this.$rowLengthCache
g.splice.apply(g,d)
c=this.$foldData,h=0
if(f=this.getFoldLine(r)){var p=f.range.compareInside(i.row,i.column)
...
return t&&this.$wrapData.length!=this.doc.getLength()&&console.error("doc.getLength() and $wrapData.length have to be the same!"),this.$updating=!1,t?this.$updateWrapData(r,s):this.$updateRowLengthCache(r,s),l},e.prototype.$updateRowLengthCache=function(e,t){this.$rowLengthCache[e]=null,this.$rowLengthCache[t]=null},e.prototype.$updateWrapData=function(e,t){var n,i,o=this.doc.getAllLines(),r=this.getTabSize(),s=this.$wrapData,a=this.$wrapLimit,l=e
for(t=Math.min(t,o.length-1);l<=t;)(i=this.getFoldLine(l,i))?(n=[],i.walk(function(e,t,i,r){var s
if(null!=e){(s=this.$getDisplayTokens(e,n.length))[0]=b
for(var a=1;a<s.length;a++)s[a]=$}else s=this.$getDisplayTokens(o[t].substring(r,i),n.length)
n=n.concat(s)}.bind(this),i.end.row,o[i.end.row].length+1),s[i.start.row]=this.$computeWrapSplits(n,a,r),l=i.end.row+1):(n=this.$getDisplayTokens(o[l]),s[l]=this.$computeWrapSplits(n,a,r),l++)},e.prototype.$computeWrapSplits=function(e,t,n){function i(){var t=0
if(0===u)return t
if(h)for(var i=0;i<e.length;i++){var o=e[i]
if(o==S)t+=1
else{if(o!=x){if(o==A)continue
break}t+=n}}return c&&!1!==h&&(t+=n),Math.min(t,u)}function o(t){for(var n=t-a,o=a;o<t;o++){var s=e[o]
12!==s&&2!==s||(n-=1)}r.length||(d=i(),r.indent=d),l+=n,r.push(l),a=t}if(0==e.length)return[]
for(var r=[],s=e.length,a=0,l=0,c=this.$wrapAsCode,h=this.$indentedSoftWrap,u=t<=Math.max(2*n,8)||!1===h?0:Math.floor(t/2),d=0;s-a>t-d;){var g=a+t-d
if(e[g-1]>=S&&e[g]>=S)o(g)
else if(e[g]!=b&&e[g]!=$){for(var p=Math.max(g-(t-(t>>2)),a-1);g>p&&e[g]<b;)g--
if(c){for(;g>p&&e[g]<b;)g--
for(;g>p&&e[g]==C;)g--}else for(;g>p&&e[g]<S;)g--
g>p?o(++g):(e[g=a+t]==w&&g--,o(g-d))}else{for(;g!=a-1&&e[g]!=b;g--);if(g>a){o(g)
continue}for(g=a+t;g<e.length&&e[g]==$;g++);if(g==e.length)break
o(g)}}return r},e.prototype.$getDisplayTokens=function(e,t){var n,o=[]
t=t||0
for(var r=0;r<e.length;r++){var s=e.charCodeAt(r)
if(9==s){n=this.getScreenTabSize(o.length+t),o.push(x)
for(var a=1;a<n;a++)o.push(A)}else 32==s?o.push(S):s>39&&s<48||s>57&&s<64?o.push(C):s>=4352&&i(s)?o.push(v,w):o.push(v)}return o},e.prototype.$getStringScreenWidth=function(e,t,n){if(0==t)return[0,0]
var o,r
for(null==t&&(t=1/0),n=n||0,r=0;r<e.length&&(9==(o=e.charCodeAt(r))?n+=this.getScreenTabSize(n):o>=4352&&i(o)?n+=2:n+=1,!(n>t));r++);return[n,r]},e.prototype.getRowLength=function(e){var t=1
...
i=this.getLine(r),p=null}var m=0,y=Math.floor(e-a)
if(this.$useWrapMode){var v=this.$wrapData[r]
v&&(o=v[y],y>0&&v.length&&(m=v.indent,s=v[y-1]||v[v.length-1],i=i.substring(s)))}return void 0!==n&&this.$bidiHandler.isBidiRow(a+y,r,y)&&(t=this.$bidiHandler.offsetToCol(n)),s+=this.$getStringScreenWidth(i,t-m)[1],this.$useWrapMode&&s>=o&&(s=o-1),p?p.idxToPosition(s):{row:r,column:s}},e.prototype.documentToScreenPosition=function(e,t){if(void 0===t)var n=this.$clipPositionToDocument(e.row,e.column)
...
if(m){for(var y=0;p.length>=m[y];)o++,y++
p=p.substring(m[y-1]||0,p.length),f=y>0?m.indent:0}}return this.lineWidgets&&this.lineWidgets[a]&&this.lineWidgets[a].rowsAbove&&(o+=this.lineWidgets[a].rowsAbove),{row:o,column:f+this.$getStringScreenWidth(p)[0]}},e.prototype.documentToScreenColumn=function(e,t){return this.documentToScreenPosition(e,t).column},e.prototype.documentToScreenRow=function(e,t){return this.documentToScreenPosition(e,t).row},e.prototype.getScreenLength=function(){var e=0,t=null
...
var o,r
for(n||(n=1/0),i=i||0,r=0;r<t.length&&!((i+="\t"===(o=t.charAt(r))?this.getScreenTabSize(i):e.getCharacterWidth(o))>n);r++);return[i,r]})},e.prototype.getPrecedingCharacter=function(){var e=this.selection.getCursor()
...
l&&l.end.row===u&&l.end.column>f||(s.push(l=new r(u,f,u+c-1,m)),c>2&&(u=u+c-2))}}else for(var y=0;y<o.length;y++){var v=i.getMatchOffsets(o[y],a)
for(d=0;d<v.length;d++){var w=v[d]
s.push(new r(y,w.offset,y,w.offset+w.length))}}if(n){var b=n.start.column,$=n.end.column
for(y=0,d=s.length-1;y<d&&s[y].start.column<b&&0==s[y].start.row;)y++
for(var C=n.end.row-n.start.row;y<d&&s[d].end.column>$&&s[d].end.row==C;)d--
for(s=s.slice(y,d+1),y=0,d=s.length;y<d;y++)s[y].start.row+=n.start.row,s[y].end.row+=n.start.row}return s},e.prototype.replace=function(e,t){var n=this.$options,i=this.$assembleRegExp(n)
if(n.$isMultiLine)return t
if(i){var o=i.exec(e)
if(!o||o[0].length!=e.length)return null
if(n.regExp||(t=t.replace(/\$/g,"$$$$")),t=e.replace(i,t),n.preserveCase){t=t.split("")
...
try{new RegExp(n,"u"),e.$supportsUnicodeFlag=!0,o+="u"}catch(r){e.$supportsUnicodeFlag=!1}if(e.wholeWord&&(n=function(e,t){function n(e,n){return void 0===n&&(n=!0),(o&&t.$supportsUnicodeFlag?new RegExp("[\\p{L}\\p{N}_]","u"):new RegExp("\\w")).test(e)||t.regExp?o&&t.$supportsUnicodeFlag?n?"(?<=^|[^\\p{L}\\p{N}_])":"(?=[^\\p{L}\\p{N}_]|$)":"\\b":""}var o=i.supportsLookbehind(),r=Array.from(e),s=r[0],a=r[r.length-1]
return n(s)+e+n(a,!1)}(n,e)),e.$isMultiLine=!t&&/[\n\r]/.test(n),e.$isMultiLine)return e.re=this.$assembleMultilineRegExp(n,o)
try{var s=new RegExp(n,o)}catch(r){s=!1}return e.re=s},e.prototype.$assembleMultilineRegExp=function(e,t){for(var n=e.replace(/\r\n|\r|\n/g,"$\n^").split("\n"),i=[],o=0;o<n.length;o++)try{i.push(new RegExp(n[o],t))}catch(r){return!1}return i},e.prototype.$matchIterator=function(e,t){var n=this.$assembleRegExp(t)
if(!n)return!1
var o=1==t.backwards,r=0!=t.skipCurrent,s=n.unicode,a=t.range,l=t.start
l||(l=a?a[o?"end":"start"]:e.selection.getRange()),l.start&&(l=l[r!=o?"end":"start"])
var c=a?a.start.row:0,h=a?a.end.row:e.getLength()-1
if(o)var u=function(e){var n=l.row
if(!g(n,l.column,e)){for(n--;n>=c;n--)if(g(n,Number.MAX_VALUE,e))return
if(0!=t.wrap)for(n=h,c=l.row;n>=c;n--)if(g(n,Number.MAX_VALUE,e))return}}
else u=function(e){var n=l.row
if(!g(n,l.column,e)){for(n+=1;n<=h;n++)if(g(n,0,e))return
if(0!=t.wrap)for(n=c,h=l.row;n<=h;n++)if(g(n,0,e))return}}
if(t.$isMultiLine)var d=n.length,g=function(t,i,r){var s=o?t-d+1:t
if(!(s<0||s+d>e.getLength())){var a=e.getLine(s),l=a.search(n[0])
if(!(!o&&l<i||-1===l)){for(var c=1;c<d;c++)if(-1==(a=e.getLine(s+c)).search(n[c]))return
var h=a.match(n[d-1])[0].length
if(!(o&&h>i))return!!r(s,l,s+d-1,h)||void 0}}}
else if(o)g=function(t,o,r){var a,l=e.getLine(t),c=[],h=0
for(n.lastIndex=0;a=n.exec(l);){var u=a[0].length
if(h=a.index,!u){if(h>=l.length)break
n.lastIndex=h+=i.skipEmptyMatch(l,h,s)}if(a.index+u>o)break
c.push(a.index,u)}for(var d=c.length-1;d>=0;d-=2){var g=c[d-1]
if(r(t,g,t,g+(u=c[d])))return!0}}
else g=function(t,o,r){var a,l,c=e.getLine(t)
for(n.lastIndex=o;l=n.exec(c);){var h=l[0].length
if(r(t,a=l.index,t,a+h))return!0
if(!h&&(n.lastIndex=a+=i.skipEmptyMatch(c,a,s),a>=c.length))return!1}}
return{forEach:u}},e}()
...
function i(e){return"object"==typeof e&&e.bindKey&&e.bindKey.position||(e.isDefault?-100:0)}var o=this&&this.__extends||function(){var e=function(t,n){return e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])},e(t,n)}
return function(t,n){function i(){this.constructor=t}if("function"!=typeof n&&null!==n)throw new TypeError("Class extends value "+String(n)+" is not a constructor or null")
...
this._addCommandToBinding(i+s,t,n)}),this)},e.prototype._addCommandToBinding=function(e,t,n){var o,r=this.commandKeyBinding
if(t)if(!r[e]||this.$singleCommand)r[e]=t
else{Array.isArray(r[e])?-1!=(o=r[e].indexOf(t))&&r[e].splice(o,1):r[e]=[r[e]],"number"!=typeof n&&(n=i(t))
var s=r[e]
for(o=0;o<s.length;o++){if(i(s[o])>n)break}s.splice(o,0,t)}else delete r[e]},e.prototype.addCommands=function(e){e&&Object.keys(e).forEach((function(t){var n=e[t]
...
return e.$keyChain&&(e.$keyChain+=" "+o,r=this.commandKeyBinding[e.$keyChain]||r),!r||"chainKeys"!=r&&"chainKeys"!=r[r.length-1]?(e.$keyChain&&(t&&4!=t||1!=n.length?(-1==t||i>0)&&(e.$keyChain=""):e.$keyChain=e.$keyChain.slice(0,-o.length-1)),{command:r}):(e.$keyChain=e.$keyChain||o,{command:"null"})}},e.prototype.getStatusText=function(e,t){return t.$keyChain||""},e}(),c=function(e){function t(t,n){var i=e.call(this,t,n)||this
return i.$singleCommand=!0,i}return o(t,e),t}(l)
c.call=function(e,t,n){l.prototype.$init.call(e,t,n,!0)},l.call=function(e,t,n){l.prototype.$init.call(e,t,n,!1)},t.HashHandler=c,t.MultiHashHandler=l})),ace.define("ace/commands/command_manager",["require","exports","module","ace/lib/oop","ace/keyboard/hash_handler","ace/lib/event_emitter"],(function(e,t,n){"use strict"
var i=this&&this.__extends||function(){var e=function(t,n){return e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])},e(t,n)}
return function(t,n){function i(){this.constructor=t}if("function"!=typeof n&&null!==n)throw new TypeError("Class extends value "+String(n)+" is not a constructor or null")
e(t,n),t.prototype=null===n?Object.create(n):(i.prototype=n.prototype,new i)}}(),o=e("../lib/oop"),r=e("../keyboard/hash_handler").MultiHashHandler,s=e("../lib/event_emitter").EventEmitter,a=function(e){function t(t,n){var i=e.call(this,n,t)||this
return i.byName=i.commands,i.setDefaultHandler("exec",(function(e){return e.args?e.command.exec(e.editor,e.args,e.event,!1):e.command.exec(e.editor,{},e.event,!0)})),i}return i(t,e),t.prototype.exec=function(e,t,n){if(Array.isArray(e)){for(var i=e.length;i--;)if(this.exec(e[i],t,n))return!0
...
t.start.column=t.end.column=0,t.end.row++,e.selection.setRange(t,!1)},multiSelectAction:"forEach",scrollIntoView:"cursor",readOnly:!0},{name:"openlink",bindKey:i("Ctrl+F3","F3"),exec:function(e){e.openLink()}},{name:"joinlines",description:"Join lines",bindKey:i(null,null),exec:function(e){for(var t=e.selection.isBackwards(),n=t?e.selection.getSelectionLead():e.selection.getSelectionAnchor(),i=t?e.selection.getSelectionAnchor():e.selection.getSelectionLead(),r=e.session.doc.getLine(n.row).length,a=e.session.doc.getTextRange(e.selection.getRange()).replace(/\n\s*/," ").length,l=e.session.doc.getLine(n.row),c=n.row+1;c<=i.row+1;c++){var h=o.stringTrimLeft(o.stringTrimRight(e.session.doc.getLine(c)))
0!==h.length&&(h=" "+h),l+=h}i.row+1<e.session.doc.getLength()-1&&(l+=e.session.doc.getNewLineCharacter()),e.clearSelection(),e.session.doc.replace(new s(n.row,0,i.row+2,0),l),a>0?(e.selection.moveCursorTo(n.row,n.column),e.selection.selectTo(n.row,n.column+a)):(r=e.session.doc.getLine(n.row).length>r?r+1:r,e.selection.moveCursorTo(n.row,r))},multiSelectAction:"forEach",readOnly:!0},{name:"invertSelection",description:"Invert selection",bindKey:i(null,null),exec:function(e){var t=e.session.doc.getLength()-1,n=e.session.doc.getLine(t).length,i=e.selection.rangeList.ranges,o=[]
...
for(r=0;r<o.length;r++)e.selection.addRange(o[r],!1)},readOnly:!0,scrollIntoView:"none"},{name:"addLineAfter",description:"Add new line after the current line",exec:function(e){e.selection.clearSelection(),e.navigateLineEnd(),e.insert("\n")},multiSelectAction:"forEach",scrollIntoView:"cursor"},{name:"addLineBefore",description:"Add new line before the current line",exec:function(e){e.selection.clearSelection()
var t=e.getCursorPosition()
e.selection.moveTo(t.row-1,Number.MAX_VALUE),e.insert("\n"),0===t.row&&e.navigateUp()},multiSelectAction:"forEach",scrollIntoView:"cursor"},{name:"openCommandPallete",exec:function(e){console.warn("This is an obsolete command. Please use `openCommandPalette` instead."),e.prompt({$type:"commands"})},readOnly:!0},{name:"openCommandPalette",description:"Open command palette",bindKey:i("F1","F1"),exec:function(e){e.prompt({$type:"commands"})},readOnly:!0},{name:"modeSelect",description:"Change language mode...",bindKey:i(null,null),exec:function(e){e.prompt({$type:"modes"})},readOnly:!0}]
for(var a=1;a<9;a++)t.commands.push({name:"foldToLevel"+a,description:"Fold To Level "+a,level:a,exec:function(e){e.session.foldToLevel(this.level)},scrollIntoView:"center",readOnly:!0})})),ace.define("ace/keyboard/gutter_handler",["require","exports","module","ace/lib/keys","ace/mouse/default_gutter_handler"],(function(e,t,n){"use strict"
...
return t?t.row:null},e.prototype.$rowToRowIndex=function(e){for(var t=0;t<this.lines.getLength();t++){if(this.lines.get(t).row==e)return t}return null},e}()
...
break
case"selectionPart":var i=this.selection.getRange(),o=this.renderer.layerConfig;(i.start.row>=o.lastRow||i.end.row<=o.firstRow)&&this.renderer.scrollSelectionIntoView(this.selection.anchor,this.selection.lead)}"animate"==n&&this.renderer.animateScrolling(this.curOp.scrollTop)}this.$lastSel=this.session.selection.toJSON(),this.prevOp=this.curOp,this.curOp=null}},e.prototype.$historyTracker=function(e){if(this.$mergeUndoDeltas){var t=this.prevOp,n=this.$mergeableCommands,i=t.command&&e.command.name==t.command.name
...
if(!r){var s=new w(t,n.row,n.column).getCurrentToken()
...
return this._signal("copy",s),C.lineMode=!!n&&s.text,s.text},e.prototype.onCopy=function(){this.commands.exec("copy",this)},e.prototype.onCut=function(){this.commands.exec("cut",this)},e.prototype.onPaste=function(e,t){var n={text:e,event:t}
this.commands.exec("paste",this,n)},e.prototype.$handlePaste=function(e){"string"==typeof e&&(e={text:e}),this._signal("paste",e)
var t=e.text,n=t===C.lineMode,i=this.session
...
r&&(e!==r.text&&(this.inVirtualSelectionMode||(this.session.mergeUndoDeltas=!1,this.mergeNextCommand=!1)),e=r.text)}if("\t"==e&&(e=this.session.getTabString()),this.selection.isEmpty()){if(this.session.getOverwrite()&&-1==e.indexOf("\n")){(s=p.fromPoints(o,o)).end.column+=e.length,this.session.remove(s)}}else{var s=this.getSelectionRange()
...
n.insert({row:o.row+1,column:0},d)}u&&i.autoOutdent(h,n,o.row)}},e.prototype.autoIndent=function(){for(var e=this.session,t=e.getMode(),n=this.selection.isEmpty()?[new p(0,0,e.doc.getLength()-1,0)]:this.selection.getAllRanges(),i="",o="",r="",s=e.getTabString(),a=0;a<n.length;a++)for(var l=n[a].start.row,c=n[a].end.row,h=l;h<=c;h++){h>0&&(i=e.getState(h-1),o=e.getLine(h-1),r=t.getNextLineIndent(i,o,s))
var u=e.getLine(h),d=t.$getIndent(u)
if(r!==d){if(d.length>0){var g=new p(h,0,h,d.length)
e.remove(g)}r.length>0&&e.insert({row:h,column:0},r)}t.autoOutdent(i,e,h)}},e.prototype.onTextInput=function(e,t){if(!t)return this.keyBinding.onTextInput(e)
...
this.insert("\n"),this.moveCursorToPosition(e)},e.prototype.setGhostText=function(e,t){this.renderer.setGhostText(e,t)},e.prototype.removeGhostText=function(){this.renderer.removeGhostText()},e.prototype.transposeLetters=function(){if(this.selection.isEmpty()){var e=this.getCursorPosition(),t=e.column
...
if(!/^\s+$/.test(n)){h=this.$getSelectedRows()
return void e.indentRows(h.first,h.last,"\t")}}var i=e.getLine(t.start.row),o=t.start,r=e.getTabSize(),a=e.documentToScreenColumn(o.row,o.column)
...
if(m)n.match(new RegExp("([_]|^|\\s)("+s.escapeRegExp(m[1])+")($|\\s)","g"))&&(h=n.replace(new RegExp(s.escapeRegExp(g[p]),"i"),(function(e){var t=g[f]
...
break}l=c}}catch(p){n={error:p}}finally{try{u&&!u.done&&(o=h.return)&&o.call(h)}finally{if(n)throw n.error}}return a},e.prototype.openLink=function(){var e=this.selection.getCursor(),t=this.findLinkAt(e.row,e.column)
...
t.duplicateLines(o,o)}else{var r=i?n.start:n.end,s=t.insert(r,t.getTextRange(n))
...
v.loadModule("ace/ext/prompt",(function(o){o.prompt(i,e,t,n)}))},e}()
...
function i(e){var t=document.createTextNode("")
e.appendChild(t)
...
return i.appendChild(r),e}var o=e("../lib/dom"),r=e("../lib/oop"),s=e("../lib/lang"),a=e("../lib/event_emitter").EventEmitter,l=e("./lines").Lines,c=e("../config").nls,h=function(){function e(e){this.element=o.createElement("div"),this.element.className="ace_layer ace_gutter-layer",e.appendChild(this.element),this.setShowFoldWidgets(this.$showFoldWidgets),this.gutterWidth=0,this.$annotations=[],this.$updateAnnotations=this.$updateAnnotations.bind(this),this.$lines=new l(this.element),this.$lines.$offsetCoefficient=1}return e.prototype.setSession=function(e){this.session&&this.session.off("change",this.$updateAnnotations),this.session=e,e&&e.on("change",this.$updateAnnotations)},e.prototype.addGutterDecoration=function(e,t){window.console&&console.warn&&console.warn("deprecated use session.addGutterDecoration"),this.session.addGutterDecoration(e,t)},e.prototype.removeGutterDecoration=function(e,t){window.console&&console.warn&&console.warn("deprecated use session.removeGutterDecoration"),this.session.removeGutterDecoration(e,t)},e.prototype.setAnnotations=function(e){this.$annotations=[]
for(var t=0;t<e.length;t++){var n=e[t],i=n.row,o=this.$annotations[i]
o||(o=this.$annotations[i]={text:[],type:[],displayText:[]})
var r=n.text,a=n.text,l=n.type
r=r?s.escapeHTML(r):n.html||"",a=a||(n.html||""),-1===o.text.indexOf(r)&&(o.text.push(r),o.type.push(l),o.displayText.push(a))
var c=n.className
c?o.className=c:"error"===l?o.className=" ace_error":"security"!==l||/\bace_error\b/.test(o.className)?"warning"!==l||/\bace_(error|security)\b/.test(o.className)?"info"!==l||o.className?"hint"===l&&!o.className&&(o.className=" ace_hint"):o.className=" ace_info":o.className=" ace_warning":o.className=" ace_security"}},e.prototype.$updateAnnotations=function(e){if(this.$annotations.length){var t=e.start.row,n=e.end.row-t
if(0!==n)if("remove"==e.action)this.$annotations.splice(t,n+1,null)
...
var t=this.session,n=e.firstRow,o=Math.min(e.lastRow+e.gutterOffset,t.getLength()-1)
this.oldLastRow=o,this.config=e,this.$lines.moveContainer(e),this.$updateCursorRow()
for(var r=t.getNextFoldLine(n),s=r?r.start.row:1/0,a=null,l=-1,c=n;;){if(c>s&&(c=r.end.row+1,s=(r=t.getNextFoldLine(c,r))?r.start.row:1/0),c>o){for(;this.$lines.getLength()>l+1;)this.$lines.pop()
break}(a=this.$lines.get(++l))?a.row=c:(a=this.$lines.createCell(c,e,this.session,i),this.$lines.push(a)),this.$renderCell(a,e,r,c),c++}this._signal("afterRender"),this.$updateGutterWidth(e)},e.prototype.$updateGutterWidth=function(e){var t=this.session,n=t.gutterRenderer||this.$renderer,i=t.$firstLineNumber,o=this.$lines.last()?this.$lines.last().text:"";(this.$fixedWidth||t.$useWrapMode)&&(o=t.getLength()+i-1)
...
e.firstRow<t.firstRow&&this.$lines.unshift(this.$renderLines(e,e.firstRow,t.firstRow-1)),n>i&&this.$lines.push(this.$renderLines(e,i+1,n)),this.updateLineHighlight(),this._signal("afterRender"),this.$updateGutterWidth(e)},e.prototype.$renderLines=function(e,t,n){for(var o=[],r=t,s=this.session.getNextFoldLine(r),a=s?s.start.row:1/0;r>a&&(r=s.end.row+1,a=(s=this.session.getNextFoldLine(r,s))?s.start.row:1/0),!(r>n);){var l=this.$lines.createCell(r,e,this.session,i)
this.$renderCell(l,e,s,r),o.push(l),r++}return o},e.prototype.$renderCell=function(e,t,n,i){var r=e.element,s=this.session,a=r.childNodes[0],l=r.childNodes[1],h=r.childNodes[2],u=h.firstChild,d=s.$firstLineNumber,g=s.$breakpoints,p=s.$decorations,f=s.gutterRenderer||this.$renderer,m=this.$showFoldWidgets&&s.foldWidgets,y=n?n.start.row:Number.MAX_VALUE,v=t.lineHeight+"px",w=this.$useSvgGutterIcons?"ace_gutter-cell_svg-icons ":"ace_gutter-cell ",b=this.$useSvgGutterIcons?"ace_icon_svg":"ace_icon",$=(f?f.getText(s,i):i+d).toString()
if(this.$highlightGutterLine&&(i==this.$cursorRow||n&&i<this.$cursorRow&&i>=y&&this.$cursorRow<=n.end.row)&&(w+="ace_gutter-active-line ",this.$cursorCell!=e&&(this.$cursorCell&&(this.$cursorCell.element.className=this.$cursorCell.element.className.replace("ace_gutter-active-line ","")),this.$cursorCell=e)),g[i]&&(w+=g[i]),p[i]&&(w+=p[i]),this.$annotations[i]&&i!==y&&(w+=this.$annotations[i].className),m){var C=m[i]
null==C&&(C=m[i]=s.getFoldWidget(i))}if(C){var S="ace_fold-widget ace_"+C,x="start"==C&&i==y&&i<n.end.row
if(x){S+=" ace_closed"
for(var A="",M=!1,k=i+1;k<=n.end.row;k++)if(this.$annotations[k]){if(" ace_error"===this.$annotations[k].className){M=!0,A=" ace_error_fold"
break}" ace_security"===this.$annotations[k].className?(M=!0,A=" ace_security_fold"):" ace_warning"===this.$annotations[k].className&&" ace_security_fold"!==A&&(M=!0,A=" ace_warning_fold")}w+=A}else S+=" ace_open"
l.className!=S&&(l.className=S),o.setStyle(l.style,"height",v),o.setStyle(l.style,"display","inline-block"),l.setAttribute("role","button"),l.setAttribute("tabindex","-1")
var L=s.getFoldWidgetRange(i)
L?l.setAttribute("aria-label",c("gutter.code-folding.range.aria-label","Toggle code folding, rows $0 through $1",[L.start.row+1,L.end.row+1])):n?l.setAttribute("aria-label",c("gutter.code-folding.closed.aria-label","Toggle code folding, rows $0 through $1",[n.start.row+1,n.end.row+1])):l.setAttribute("aria-label",c("gutter.code-folding.open.aria-label","Toggle code folding, row $0",[i+1])),x?(l.setAttribute("aria-expanded","false"),l.setAttribute("title",c("gutter.code-folding.closed.title","Unfold code"))):(l.setAttribute("aria-expanded","true"),l.setAttribute("title",c("gutter.code-folding.open.title","Fold code")))}else l&&(o.setStyle(l.style,"display","none"),l.setAttribute("tabindex","0"),l.removeAttribute("role"),l.removeAttribute("aria-label"))
if(M&&this.$showFoldedAnnotations){switch(h.className="ace_gutter_annotation",u.className=b,u.className+=A,o.setStyle(u.style,"height",v),o.setStyle(h.style,"display","block"),o.setStyle(h.style,"height",v),A){case" ace_error_fold":T=c("gutter.annotation.aria-label.error","Error, read annotations row $0",[$])
break
case" ace_security_fold":T=c("gutter.annotation.aria-label.security","Security finding, read annotations row $0",[$])
break
case" ace_warning_fold":T=c("gutter.annotation.aria-label.warning","Warning, read annotations row $0",[$])}h.setAttribute("aria-label",T),h.setAttribute("tabindex","-1"),h.setAttribute("role","button")}else if(this.$annotations[i]){var T
switch(h.className="ace_gutter_annotation",u.className=b,this.$useSvgGutterIcons?u.className+=this.$annotations[i].className:r.classList.add(this.$annotations[i].className.replace(" ","")),o.setStyle(u.style,"height",v),o.setStyle(h.style,"display","block"),o.setStyle(h.style,"height",v),this.$annotations[i].className){case" ace_error":T=c("gutter.annotation.aria-label.error","Error, read annotations row $0",[$])
break
case" ace_security":T=c("gutter.annotation.aria-label.security","Security finding, read annotations row $0",[$])
break
case" ace_warning":T=c("gutter.annotation.aria-label.warning","Warning, read annotations row $0",[$])
break
case" ace_info":T=c("gutter.annotation.aria-label.info","Info, read annotations row $0",[$])
break
case" ace_hint":T=c("gutter.annotation.aria-label.hint","Suggestion, read annotations row $0",[$])}h.setAttribute("aria-label",T),h.setAttribute("tabindex","-1"),h.setAttribute("role","button")}else o.setStyle(h.style,"display","none"),h.removeAttribute("aria-label"),h.removeAttribute("role"),h.setAttribute("tabindex","0")
return $!==a.data&&(a.data=$),r.className!=w&&(r.className=w),o.setStyle(e.element.style,"height",this.$lines.computeLineHeight(i,t,s)+"px"),o.setStyle(e.element.style,"top",this.$lines.computeLineTop(i,t,s)+"px"),e.text=$,"none"===h.style.display&&"none"===l.style.display?e.element.setAttribute("aria-hidden",!0):e.element.setAttribute("aria-hidden",!1),e},e.prototype.setHighlightGutterLine=function(e){this.$highlightGutterLine=e},e.prototype.setShowLineNumbers=function(e){this.$renderer=!e&&{getWidth:function(){return 0},getText:function(){return""}}},e.prototype.getShowLineNumbers=function(){return this.$showLineNumbers},e.prototype.setShowFoldWidgets=function(e){e?o.addCssClass(this.element,"ace_folding-enabled"):o.removeCssClass(this.element,"ace_folding-enabled"),this.$showFoldWidgets=e,this.$padding=null},e.prototype.getShowFoldWidgets=function(){return this.$showFoldWidgets},e.prototype.$computePadding=function(){if(!this.element.firstChild)return{left:0,right:0}
...
h.prototype.$fixedWidth=!1,h.prototype.$highlightGutterLine=!0,h.prototype.$renderer="",h.prototype.$showLineNumbers=!0,h.prototype.$showFoldWidgets=!0,r.implement(h.prototype,a),t.Gutter=h})),ace.define("ace/layer/marker",["require","exports","module","ace/range","ace/lib/dom"],(function(e,t,n){"use strict"
function i(e,t,n,i){return(e?1:0)|(t?2:0)|(n?4:0)|(i?8:0)}var o=e("../range").Range,r=e("../lib/dom"),s=function(){function e(e){this.element=r.createElement("div"),this.element.className="ace_layer ace_marker-layer",e.appendChild(this.element)}return e.prototype.setPadding=function(e){this.$padding=e},e.prototype.setSession=function(e){this.session=e},e.prototype.setMarkers=function(e){this.markers=e},e.prototype.elt=function(e,t){var n=-1!=this.i&&this.element.childNodes[this.i]
...
this.elt(n+(u?" ace_br"+u:""),"height:"+s+"px;right:"+r+"px;top:"+a+"px;left:"+r+"px;"+(o||""))}},e.prototype.drawSingleLineMarker=function(e,t,n,i,o,r){if(this.session.$bidiHandler.isBidiRow(t.start.row))return this.drawBidiSingleLineMarker(e,t,n,i,o,r)
...
s.prototype.$padding=0,t.Marker=s})),ace.define("ace/layer/text_util",["require","exports","module"],(function(e,t,n){var i=new Set(["text","rparen","lparen"])
t.isTextToken=function(e){return i.has(e)}})),ace.define("ace/layer/text",["require","exports","module","ace/lib/oop","ace/lib/dom","ace/lib/lang","ace/layer/lines","ace/lib/event_emitter","ace/config","ace/layer/text_util"],(function(e,t,n){"use strict"
var i=e("../lib/oop"),o=e("../lib/dom"),r=e("../lib/lang"),s=e("./lines").Lines,a=e("../lib/event_emitter").EventEmitter,l=e("../config").nls,c=e("./text_util").isTextToken,h=function(){function e(e){this.dom=o,this.element=this.dom.createElement("div"),this.element.className="ace_layer ace_text-layer",e.appendChild(this.element),this.$updateEolChar=this.$updateEolChar.bind(this),this.$lines=new s(this.element)}return e.prototype.$updateEolChar=function(){var e=this.session.doc,t="\n"==e.getNewLineCharacter()&&"windows"!=e.getNewLineMode()?this.EOL_CHAR_LF:this.EOL_CHAR_CRLF
...
this.tabSize=e
for(var t=this.$tabStrings=[0],n=1;n<e+1;n++)if(this.showTabs){(i=this.dom.createElement("span")).className="ace_invisible ace_invisible_tab",i.textContent=r.stringRepeat(this.TAB_CHAR,n),t.push(i)}else t.push(this.dom.createTextNode(r.stringRepeat(" ",n),this.element))
...
i.push(this.$renderLinesFragment(e,t,n))},e.prototype.$renderToken=function(e,t,n,i){for(var o,s=this,a=/(\t)|( +)|([\x00-\x1f\x80-\xa0\xad\u1680\u180E\u2000-\u200f\u2028\u2029\u202F\u205F\uFEFF\uFFF9-\uFFFC\u2066\u2067\u2068\u202A\u202B\u202D\u202E\u202C\u2069\u2060\u2061\u2062\u2063\u2064\u206A\u206B\u206B\u206C\u206D\u206E\u206F]+)|(\u3000)|([\u1100-\u115F\u11A3-\u11A7\u11FA-\u11FF\u2329-\u232A\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFB\u3001-\u303E\u3041-\u3096\u3099-\u30FF\u3105-\u312D\u3131-\u318E\u3190-\u31BA\u31C0-\u31E3\u31F0-\u321E\u3220-\u3247\u3250-\u32FE\u3300-\u4DBF\u4E00-\uA48C\uA490-\uA4C6\uA960-\uA97C\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFAFF\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE66\uFE68-\uFE6B\uFF01-\uFF60\uFFE0-\uFFE6]|[\uD800-\uDBFF][\uDC00-\uDFFF])/g,h=this.dom.createFragment(this.element),u=0;o=a.exec(i);){var d=o[1],g=o[2],p=o[3],f=o[4],m=o[5]
if(s.showSpaces||!g){var y=u!=o.index?i.slice(u,o.index):""
if(u=o.index+o[0].length,y&&h.appendChild(this.dom.createTextNode(y,this.element)),d){var v=s.session.getScreenTabSize(t+o.index)
h.appendChild(s.$tabStrings[v].cloneNode(!0)),t+=v-1}else if(g)if(s.showSpaces){(b=this.dom.createElement("span")).className="ace_invisible ace_invisible_space",b.textContent=r.stringRepeat(s.SPACE_CHAR,g.length),h.appendChild(b)}else h.appendChild(this.dom.createTextNode(g,this.element))
else if(p){(b=this.dom.createElement("span")).className="ace_invisible ace_invisible_space ace_invalid",b.textContent=r.stringRepeat(s.SPACE_CHAR,p.length),h.appendChild(b)}else if(f){t+=1,(b=this.dom.createElement("span")).style.width=2*s.config.characterWidth+"px",b.className=s.showSpaces?"ace_cjk ace_invisible ace_invisible_space":"ace_cjk",b.textContent=s.showSpaces?s.SPACE_CHAR:f,h.appendChild(b)}else if(m){t+=1,(b=this.dom.createElement("span")).style.width=2*s.config.characterWidth+"px",b.className="ace_cjk",b.textContent=m,h.appendChild(b)}}}if(h.appendChild(this.dom.createTextNode(u?i.slice(u):i,this.element)),c(n.type))e.appendChild(h)
else{var w="ace_"+n.type.replace(/\./g," ace_"),b=this.dom.createElement("span")
"fold"==n.type&&(b.style.width=n.value.length*this.config.characterWidth+"px",b.setAttribute("title",l("inline-fold.closed.title","Unfold code"))),b.className=w,b.appendChild(h),e.appendChild(b)}return t+i.length},e.prototype.renderIndentGuide=function(e,t,n){var i=t.search(this.$indentGuideRe)
if(i<=0||i>=n)return t
...
if(this.$highlightIndentGuideMarker={indentLevel:i,start:t.row},this.session.$bracketHighlight)for(var o=this.session.$bracketHighlight.ranges,r=0;r<o.length;r++)if(t.row!==o[r].start.row){this.$highlightIndentGuideMarker.end=o[r].start.row+1,t.row>o[r].start.row?this.$highlightIndentGuideMarker.dir=-1:this.$highlightIndentGuideMarker.dir=1
break}if(!this.$highlightIndentGuideMarker.end&&""!==e[t.row]&&t.column===e[t.row].length){this.$highlightIndentGuideMarker.dir=1
for(r=t.row+1;r<e.length;r++){var s=e[r],a=/^\s*/.exec(s)[0].length
if(""!==s&&(this.$highlightIndentGuideMarker.end=r,a<=n))break}}this.$renderHighlightIndentGuide()}}},e.prototype.$clearActiveIndentGuide=function(){this.element.querySelectorAll(".ace_indent-guide-active").forEach((function(e){e.classList.remove("ace_indent-guide-active")}))},e.prototype.$setIndentGuideActive=function(e,t){if(""!==this.session.doc.getLine(e.row)){var n=e.element
if(e.element.classList&&e.element.classList.contains("ace_line_group")){if(!(e.element.childNodes.length>0))return
n=e.element.childNodes[0]}var i=n.childNodes
if(i){var o=i[t-1]
o&&o.classList&&o.classList.contains("ace_indent-guide")&&o.classList.add("ace_indent-guide-active")}}},e.prototype.$renderHighlightIndentGuide=function(){if(this.$lines){var e=this.$lines.cells
...
this.$setIndentGuideActive(i,t)}}else for(n=e.length-1;n>=0;n--){i=e[n]
if(this.$highlightIndentGuideMarker.end&&i.row<this.$highlightIndentGuideMarker.start){if(i.row<this.$highlightIndentGuideMarker.end)break
...
if(r&&r.length){this.$renderWrappedLine(e,i,r)
o=e.lastChild}else{o=e
this.$useLineGroups()&&(o=this.$createLineElement(),e.appendChild(o)),this.$renderSimpleLine(o,i)}}else this.$useLineGroups()&&(o=this.$createLineElement(),e.appendChild(o))
...
h.prototype.EOF_CHAR="¶",h.prototype.EOL_CHAR_LF="¬",h.prototype.EOL_CHAR_CRLF="¤",h.prototype.EOL_CHAR=h.prototype.EOL_CHAR_LF,h.prototype.TAB_CHAR="—",h.prototype.SPACE_CHAR="·",h.prototype.$padding=0,h.prototype.MAX_LINE_LENGTH=1e4,h.prototype.showInvisibles=!1,h.prototype.showSpaces=!1,h.prototype.showTabs=!1,h.prototype.showEOL=!1,h.prototype.displayIndentGuides=!0,h.prototype.$highlightIndentGuides=!0,h.prototype.$tabStrings=[],h.prototype.destroy={},h.prototype.onChangeTabSize=h.prototype.$computeTabString,i.implement(h.prototype,a),t.Text=h})),ace.define("ace/layer/cursor",["require","exports","module","ace/lib/dom"],(function(e,t,n){"use strict"
...
return i.scrollTop=0,i.scrollHeight=0,n.$scrollbarWidth=i.width=r.scrollbarWidth(t.ownerDocument),i.inner.style.width=i.element.style.width=(i.width||15)+5+"px",i.$minWidth=0,i}return i(t,e),t.prototype.onScroll=function(){if(!this.skipEvent){if(this.scrollTop=this.element.scrollTop,1!=this.coeff){var e=this.element.clientHeight/this.scrollHeight
this.scrollTop=this.scrollTop*(1-e)/(this.coeff-e)}this._emit("scroll",{data:this.scrollTop})}this.skipEvent=!1},t.prototype.getWidth=function(){return Math.max(this.isVisible?this.width:0,this.$minWidth||0)},t.prototype.setHeight=function(e){this.element.style.height=e+"px"},t.prototype.setScrollHeight=function(e){this.scrollHeight=e,e>l?(this.coeff=l/e,e=l):1!=this.coeff&&(this.coeff=1),this.inner.style.height=e+"px"},t.prototype.setScrollTop=function(e){this.scrollTop!=e&&(this.skipEvent=!0,this.scrollTop=e,this.element.scrollTop=e*this.coeff)},t}(c)
h.prototype.setInnerHeight=h.prototype.setScrollHeight
var u=function(e){function t(t,n){var i=e.call(this,t,"-h")||this
return i.scrollLeft=0,i.height=n.$scrollbarWidth,i.inner.style.height=i.element.style.height=(i.height||15)+5+"px",i}return i(t,e),t.prototype.onScroll=function(){this.skipEvent||(this.scrollLeft=this.element.scrollLeft,this._emit("scroll",{data:this.scrollLeft})),this.skipEvent=!1},t.prototype.getHeight=function(){return this.isVisible?this.height:0},t.prototype.setWidth=function(e){this.element.style.width=e+"px"},t.prototype.setInnerWidth=function(e){this.inner.style.width=e+"px"},t.prototype.setScrollWidth=function(e){this.inner.style.width=e+"px"},t.prototype.setScrollLeft=function(e){this.scrollLeft!=e&&(this.skipEvent=!0,this.scrollLeft=this.element.scrollLeft=e)},t}(c)
t.ScrollBar=h,t.ScrollBarV=h,t.ScrollBarH=u,t.VScrollBar=h,t.HScrollBar=u})),ace.define("ace/scrollbar_custom",["require","exports","module","ace/lib/oop","ace/lib/dom","ace/lib/event","ace/lib/event_emitter"],(function(e,t,n){"use strict"
var i=this&&this.__extends||function(){var e=function(t,n){return e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])},e(t,n)}
return function(t,n){function i(){this.constructor=t}if("function"!=typeof n&&null!==n)throw new TypeError("Class extends value "+String(n)+" is not a constructor or null")
e(t,n),t.prototype=null===n?Object.create(n):(i.prototype=n.prototype,new i)}}(),o=e("./lib/oop"),r=e("./lib/dom"),s=e("./lib/event"),a=e("./lib/event_emitter").EventEmitter
r.importCssString(".ace_editor>.ace_sb-v div, .ace_editor>.ace_sb-h div{\n  position: absolute;\n  background: rgba(128, 128, 128, 0.6);\n  -moz-box-sizing: border-box;\n  box-sizing: border-box;\n  border: 1px solid #bbb;\n  border-radius: 2px;\n  z-index: 8;\n}\n.ace_editor>.ace_sb-v, .ace_editor>.ace_sb-h {\n  position: absolute;\n  z-index: 6;\n  background: none;\n  overflow: hidden!important;\n}\n.ace_editor>.ace_sb-v {\n  z-index: 6;\n  right: 0;\n  top: 0;\n  width: 12px;\n}\n.ace_editor>.ace_sb-v div {\n  z-index: 8;\n  right: 0;\n  width: 100%;\n}\n.ace_editor>.ace_sb-h {\n  bottom: 0;\n  left: 0;\n  height: 12px;\n}\n.ace_editor>.ace_sb-h div {\n  bottom: 0;\n  height: 100%;\n}\n.ace_editor>.ace_sb_grabbed {\n  z-index: 8;\n  background: #000;\n}","ace_scrollbar.css",!1)
var l=function(){function e(e,t){this.element=r.createElement("div"),this.element.className="ace_sb"+t,this.inner=r.createElement("div"),this.inner.className="",this.element.appendChild(this.inner),this.VScrollWidth=12,this.HScrollHeight=12,e.appendChild(this.element),this.setVisible(!1),this.skipEvent=!1,s.addMultiMouseDownListener(this.element,[500,300,300],this,"onMouseDown")}return e.prototype.setVisible=function(e){this.element.style.display=e?"":"none",this.isVisible=e,this.coeff=1},e}()
o.implement(l.prototype,a)
var c=function(e){function t(t,n){var i=e.call(this,t,"-v")||this
...
s.capture(this.inner,(function(e){i=e.clientY}),(function(){clearInterval(a)}))
var a=setInterval((function(){if(void 0!==i){var e=n.scrollTopFromThumbTop(r+i-o)
e!==n.scrollTop&&n._emit("scroll",{data:e})}}),20)
return s.preventDefault(t)}var l=t.clientY-this.element.getBoundingClientRect().top-this.thumbHeight/2
return this._emit("scroll",{data:this.scrollTopFromThumbTop(l)}),s.preventDefault(t)}},t.prototype.getHeight=function(){return this.height},t.prototype.scrollTopFromThumbTop=function(e){var t=e*(this.pageHeight-this.viewHeight)/(this.slideHeight-this.thumbHeight)
return(t>>=0)<0?t=0:t>this.pageHeight-this.viewHeight&&(t=this.pageHeight-this.viewHeight),t},t.prototype.getWidth=function(){return Math.max(this.isVisible?this.width:0,this.$minWidth||0)},t.prototype.setHeight=function(e){this.height=Math.max(0,e),this.slideHeight=this.height,this.viewHeight=this.height,this.setScrollHeight(this.pageHeight,!0)},t.prototype.setScrollHeight=function(e,t){(this.pageHeight!==e||t)&&(this.pageHeight=e,this.thumbHeight=this.slideHeight*this.viewHeight/this.pageHeight,this.thumbHeight>this.slideHeight&&(this.thumbHeight=this.slideHeight),this.thumbHeight<15&&(this.thumbHeight=15),this.inner.style.height=this.thumbHeight+"px",this.scrollTop>this.pageHeight-this.viewHeight&&(this.scrollTop=this.pageHeight-this.viewHeight,this.scrollTop<0&&(this.scrollTop=0),this._emit("scroll",{data:this.scrollTop})))},t.prototype.setScrollTop=function(e){this.scrollTop=e,e<0&&(e=0),this.thumbTop=e*(this.slideHeight-this.thumbHeight)/(this.pageHeight-this.viewHeight),this.inner.style.top=this.thumbTop+"px"},t}(l)
c.prototype.setInnerHeight=c.prototype.setScrollHeight
var h=function(e){function t(t,n){var i=e.call(this,t,"-h")||this
...
s.capture(this.inner,(function(e){i=e.clientX}),(function(){clearInterval(a)}))
var a=setInterval((function(){if(void 0!==i){var e=n.scrollLeftFromThumbLeft(r+i-o)
e!==n.scrollLeft&&n._emit("scroll",{data:e})}}),20)
return s.preventDefault(t)}var l=t.clientX-this.element.getBoundingClientRect().left-this.thumbWidth/2
return this._emit("scroll",{data:this.scrollLeftFromThumbLeft(l)}),s.preventDefault(t)}},t.prototype.getHeight=function(){return this.isVisible?this.height:0},t.prototype.scrollLeftFromThumbLeft=function(e){var t=e*(this.pageWidth-this.viewWidth)/(this.slideWidth-this.thumbWidth)
return(t>>=0)<0?t=0:t>this.pageWidth-this.viewWidth&&(t=this.pageWidth-this.viewWidth),t},t.prototype.setWidth=function(e){this.width=Math.max(0,e),this.element.style.width=this.width+"px",this.slideWidth=this.width,this.viewWidth=this.width,this.setScrollWidth(this.pageWidth,!0)},t.prototype.setScrollWidth=function(e,t){(this.pageWidth!==e||t)&&(this.pageWidth=e,this.thumbWidth=this.slideWidth*this.viewWidth/this.pageWidth,this.thumbWidth>this.slideWidth&&(this.thumbWidth=this.slideWidth),this.thumbWidth<15&&(this.thumbWidth=15),this.inner.style.width=this.thumbWidth+"px",this.scrollLeft>this.pageWidth-this.viewWidth&&(this.scrollLeft=this.pageWidth-this.viewWidth,this.scrollLeft<0&&(this.scrollLeft=0),this._emit("scroll",{data:this.scrollLeft})))},t.prototype.setScrollLeft=function(e){this.scrollLeft=e,e<0&&(e=0),this.thumbLeft=e*(this.slideWidth-this.thumbWidth)/(this.pageWidth-this.viewWidth),this.inner.style.left=this.thumbLeft+"px"},t}(l)
h.prototype.setInnerWidth=h.prototype.setScrollWidth,t.ScrollBar=c,t.ScrollBarV=c,t.ScrollBarH=h,t.VScrollBar=c,t.HScrollBar=h})),ace.define("ace/renderloop",["require","exports","module","ace/lib/event"],(function(e,t,n){"use strict"
...
return[t.left,t.top]}e&&(e=r(1/this.$getZoom(this.el),e))
...
if(t){var f=t,m=d[0]*f[0]/u+d[1]*f[1]/u+1,y=o(r(f[0],g),r(f[1],p))
return o(r(1/m/u,y),a)}var v=i(e,a),w=n(i(g,r(d[0],v)),i(p,r(d[1],v)),v)
return r(u,w)},e}()
...
if(g){l=this.compensateFoldRows(g.row,r),c=Math.round((g.row-l)*this.lineHeight*this.heightRatio)
n.fillStyle="rgba(0, 0, 0, 0.5)",n.fillRect(0,c,this.canvasWidth,2)}},e.prototype.compensateFoldRows=function(e,t){var n=0
...
i||(i=o.clientHeight||o.scrollHeight),!i&&this.$maxLines&&this.lineHeight>1&&(!o.style.height||"0px"==o.style.height)&&(o.style.height="1px",i=o.clientHeight||o.scrollHeight),n||(n=o.clientWidth||o.scrollWidth)
...
var g,p,f=this.scrollTop%this.lineHeight,m=Math.ceil(l/this.lineHeight)-1,y=Math.max(0,Math.round((this.scrollTop-f)/this.lineHeight)),v=y+m,w=this.lineHeight
y=e.screenToDocumentRow(y,0)
var b=e.getFoldLine(y)
b&&(y=b.start.row),g=e.documentToScreenRow(y,0),p=e.getRowLength(y)*w,v=Math.min(e.screenToDocumentRow(v,0),e.getLength()-1),l=t.scrollerHeight+e.getRowLength(v)*w+p,f=this.scrollTop-g*w
var $=0
return(this.layerConfig.width!=o||s)&&($=this.CHANGE_H_SCROLL),(s||d)&&($|=this.$updateCachedSize(!0,this.gutterWidth,t.width,t.height),this._signal("scrollbarVisibilityChanged"),d&&(o=this.$getLongestLine())),this.layerConfig={width:o,padding:this.$padding,firstRow:y,firstRowScreen:g,lastRow:v,lineHeight:w,characterWidth:this.characterWidth,minHeight:l,maxHeight:i,offset:f,gutterOffset:w?Math.max(0,Math.ceil((f+t.height-t.scrollerHeight)/w)):0,height:this.$size.scrollerHeight},this.session.$bidiHandler&&this.session.$bidiHandler.setContentWidth(o-this.$padding),$},e.prototype.$updateLines=function(){if(this.$changedLines){var e=this.$changedLines.firstRow,t=this.$changedLines.lastRow
...
return this.session.setScrollTop(o),o},e.prototype.$calcSteps=function(e,t){var n=0,i=this.STEPS,o=[],r=function(e,t,n){return n*(Math.pow(e-1,3)+1)+t}
for(n=0;n<i;++n)o.push(r(n/this.STEPS,e,t-e))
return o},e.prototype.scrollToLine=function(e,t,n,i){var o=this.$cursorLayer.getPixelPosition({row:e,column:0}).top
t&&(o-=this.$size.scrollerHeight/2)
var r=this.scrollTop
this.session.setScrollTop(o),!1!==n&&this.animateScrolling(r,i)},e.prototype.animateScrolling=function(e,t){function n(){o.$timer=clearInterval(o.$timer),o.$scrollAnimation=null,o.$stopAnimation=!1,t&&t()}var i=this.scrollTop
if(this.$animatedScroll){var o=this
if(e!=i){if(this.$scrollAnimation){var r=this.$scrollAnimation.steps
if(r.length&&(e=r[0])==i)return}var s=o.$calcSteps(e,i)
this.$scrollAnimation={from:e,to:i,steps:s},clearInterval(this.$timer),o.session.setScrollTop(s.shift()),o.session.$scrollTop=i,this.$timer=setInterval((function(){if(!o.$stopAnimation)return o.session?void(s.length?(o.session.setScrollTop(s.shift()),o.session.$scrollTop=i):null!=i?(o.session.$scrollTop=-1,o.session.setScrollTop(i),i=null):n()):clearInterval(o.$timer)
n()}),10)}}},e.prototype.scrollToY=function(e){this.scrollTop!==e&&(this.$loop.schedule(this.CHANGE_SCROLL),this.scrollTop=e)},e.prototype.scrollToX=function(e){this.scrollLeft!==e&&(this.scrollLeft=e),this.$loop.schedule(this.CHANGE_H_SCROLL)},e.prototype.scrollTo=function(e,t){this.session.setScrollTop(t),this.session.setScrollLeft(e)},e.prototype.scrollBy=function(e,t){t&&this.session.setScrollTop(this.session.getScrollTop()+t),e&&this.session.setScrollLeft(this.session.getScrollLeft()+e)},e.prototype.isScrollableBy=function(e,t){return t<0&&this.session.getScrollTop()>=1-this.scrollMargin.top||(t>0&&this.session.getScrollTop()+this.$size.scrollerHeight-this.layerConfig.maxHeight<-1+this.scrollMargin.bottom||(e<0&&this.session.getScrollLeft()>=1-this.scrollMargin.left||(e>0&&this.session.getScrollLeft()+this.$size.scrollerWidth-this.layerConfig.width<-1+this.scrollMargin.right||void 0)))},e.prototype.pixelToScreenCoordinates=function(e,t){var n
...
var r=this.$calculateWrappedTextChunks(e,i)
this.addToken(r[0].text,"ghost_text",i.row,i.column),this.$ghostText={text:e,position:{row:i.row,column:i.column}}
var s=o.createElement("div")
if(r.length>1){var a,l=this.hideTokensAfterPosition(i.row,i.column)
r.slice(1).forEach((function(e){var t=o.createElement("div"),n=o.createElement("span")
n.className="ace_ghost_text",e.wrapped&&(t.className="ghost_text_line_wrapped"),0===e.text.length&&(e.text=" "),n.appendChild(o.createTextNode(e.text)),t.appendChild(n),s.appendChild(t),a=t})),l.forEach((function(e){var t=o.createElement("span")
$(e.type)||(t.className="ace_"+e.type.replace(/\./g," ace_")),t.appendChild(o.createTextNode(e.value)),a.appendChild(t)})),this.$ghostTextWidget={el:s,row:i.row,column:i.column,className:"ace_ghost_text_container"},this.session.widgetManager.addLineWidget(this.$ghostTextWidget)
var c=this.$cursorLayer.getPixelPosition(i,!0),h=this.container.getBoundingClientRect().height,u=r.length*this.lineHeight
if(u<h-c.top)return
u<h?this.scrollBy(0,(r.length-1)*this.lineHeight):this.scrollToRow(i.row)}},e.prototype.$calculateWrappedTextChunks=function(e,t){var n=this.$size.scrollerWidth-2*this.$padding,i=Math.floor(n/this.characterWidth)-2
i=i<=0?60:i
for(var o=e.split(/\r?\n/),r=[],s=0;s<o.length;s++){var a=this.session.$getDisplayTokens(o[s],t.column),l=this.session.$computeWrapSplits(a,i,this.session.$tabSize)
if(l.length>0){var c=0
l.push(o[s].length)
for(var h=0;h<l.length;h++){var u=o[s].slice(c,l[h])
r.push({text:u,wrapped:!0}),c=l[h]}}else r.push({text:o[s],wrapped:!1})}return r},e.prototype.removeGhostText=function(){if(this.$ghostText){var e=this.$ghostText.position
...
function i(e){if("undefined"==typeof Worker)return{postMessage:function(){},terminate:function(){}}
if(a.get("loadWorkerFromBlob")){var t=function(e){var t="importScripts('"+r.qualifyURL(e)+"');"
try{return new Blob([t],{type:"application/javascript"})}catch(n){var i=new(window.BlobBuilder||window.WebKitBlobBuilder||window.MozBlobBuilder)
return i.append(t),i.getBlob("application/javascript")}}(e),i=(window.URL||window.webkitURL).createObjectURL(t)
return new Worker(i)}return new Worker(e)}var o=e("../lib/oop"),r=e("../lib/net"),s=e("../lib/event_emitter").EventEmitter,a=e("../config"),l=function(e){e.postMessage||(e=this.$createWorkerFromOldConfig.apply(this,arguments)),this.$worker=e,this.$sendDeltaQueue=this.$sendDeltaQueue.bind(this),this.changeListener=this.changeListener.bind(this),this.onMessage=this.onMessage.bind(this),this.callbackId=1,this.callbacks={},this.$worker.onmessage=this.onMessage};(function(){o.implement(this,s),this.$createWorkerFromOldConfig=function(t,n,o,r,s){if(e.nameToUrl&&!e.toUrl&&(e.toUrl=e.nameToUrl),a.get("packaged")||!e.toUrl)r=r||a.moduleUrl(n,"worker")
else{var l=this.$normalizePath
r=r||l(e.toUrl("ace/worker/worker.js",null,"_"))
var c={}
t.forEach((function(t){c[t]=l(e.toUrl(t,null,"_").replace(/(\.js)?(\?.*)?$/,""))}))}return this.$worker=i(r),s&&this.send("importScripts",s),this.$worker.postMessage({init:!0,tlns:c,module:n,classname:o}),this.$worker},this.onMessage=function(e){var t=e.data
...
t.UIWorkerClient=function(e,t,n){var i=null,o=!1,r=Object.create(s),c=[],h=new l({messageBuffer:c,terminate:function(){},postMessage:function(e){c.push(e),i&&(o?setTimeout(u):u())}})
...
return r.postMessage=function(e){h.onMessage({data:e})},r.callback=function(e,t){this.postMessage({type:"call",id:t,data:e})},r.emit=function(e,t){this.postMessage({type:"event",name:e,data:t})},a.loadModule(["worker",t],(function(e){for(i=new e[n](r);c.length;)u()})),h},t.WorkerClient=l,t.createWorker=i})),ace.define("ace/placeholder",["require","exports","module","ace/range","ace/lib/event_emitter","ace/lib/oop"],(function(e,t,n){"use strict"
...
this.doc.remove(new i(a.row,a.column,a.row,a.column-n))}this.$updating=!1,this.updateMarkers()}},e.prototype.updateAnchors=function(e){this.pos.onChange(e)
...
r.implement(s.prototype,o),t.PlaceHolder=s})),ace.define("ace/mouse/multi_select_handler",["require","exports","module","ace/lib/event","ace/lib/useragent"],(function(e,t,n){function i(e,t){return e.row==t.row&&e.column==t.column}var o=e("../lib/event"),r=e("../lib/useragent")
t.onMouseDown=function(e){var t=e.domEvent,n=t.altKey,s=t.shiftKey,a=t.ctrlKey,l=e.getAccelKey(),c=e.getButton()
if(a&&r.isMac&&(c=t.button),e.editor.inMultiSelectMode&&2==c)e.editor.textInput.onContextMenu(e.domEvent)
else if(a||n||l){if(0===c){var h,u=e.editor,d=u.selection,g=u.inMultiSelectMode,p=e.getDocumentPosition(),f=d.getCursor(),m=e.inSelection()||d.isEmpty()&&i(p,f),y=e.x,v=e.y,w=u.session,b=u.renderer.pixelToScreenCoordinates(y,v),$=b
...
if(h&&r.isMac&&t.ctrlKey&&u.$mouseHandler.cancelContextMenu(),"add"==h){if(!g&&m)return
...
S&&e.isEmpty()&&i(S.cursor,e.cursor)?d.substractPoint(e.cursor):(s?d.substractPoint(C.cursor):C&&(u.removeSelectionMarker(C),d.addRange(C)),d.addRange(e)),u.inVirtualSelectionMode=!1}))}else if("block"==h){e.stop(),u.inVirtualSelectionMode=!0
var x,A=[],M=function(){var e=u.renderer.pixelToScreenCoordinates(y,v),t=w.screenToDocumentPosition(e.row,e.column,e.offsetX)
i($,e)&&i(t,d.lead)||($=e,u.selection.moveToPosition(t),u.renderer.scrollCursorIntoView(),u.removeSelectionMarkers(A),A=d.rectangularRangeBlock($,b),u.$mouseHandler.$clickSelection&&1==A.length&&A[0].isEmpty()&&(A[0]=u.$mouseHandler.$clickSelection.clone()),A.forEach(u.addSelectionMarker,u),u.updateSelectionMarkers())}
g&&!l?d.toSingleRange():!g&&l&&(x=d.toOrientedRange(),u.addSelectionMarker(x)),s?b=w.documentToScreenPosition(d.lead):d.moveToPosition(p),$={row:-1,column:-1}
var k=M
o.capture(u.container,(function(e){y=e.clientX,v=e.clientY}),(function(e){M(),clearInterval(L),u.removeSelectionMarkers(A),A.length||(A=[d.toOrientedRange()]),x&&(u.removeSelectionMarker(x),d.toSingleRange(x))
for(var t=0;t<A.length;t++)d.addRange(A[t])
u.inVirtualSelectionMode=!1,u.$mouseHandler.$clickSelection=null}))
var L=setInterval((function(){k()}),20)
...
t.keyboardHandler=new i(t.multiSelectCommands)})),ace.define("ace/multi_select",["require","exports","module","ace/range_list","ace/range","ace/selection","ace/mouse/multi_select_handler","ace/lib/event","ace/lib/lang","ace/commands/multi_select_commands","ace/search","ace/edit_session","ace/editor","ace/config"],(function(e,t,n){function i(e,t){return e.row==t.row&&e.column==t.column}function o(e){e.$multiselectOnSessionChange||(e.$onAddRange=e.$onAddRange.bind(e),e.$onRemoveRange=e.$onRemoveRange.bind(e),e.$onMultiSelect=e.$onMultiSelect.bind(e),e.$onSingleSelect=e.$onSingleSelect.bind(e),e.$multiselectOnSessionChange=t.onSessionChange.bind(e),e.$checkMultiselectChange=e.$checkMultiselectChange.bind(e),e.$multiselectOnSessionChange(e),e.on("changeSession",e.$multiselectOnSessionChange),e.on("mousedown",l),e.commands.addCommands(u.defaultCommands),function(e){function t(t){i&&(e.renderer.setMouseCursor(""),i=!1)}if(!e.textInput)return
var n=e.textInput.getElement(),i=!1
c.addListener(n,"keydown",(function(n){var o=18==n.keyCode&&!(n.ctrlKey||n.shiftKey||n.metaKey)
e.$blockSelectEnabled&&o?i||(e.renderer.setMouseCursor("crosshair"),i=!0):i&&t()}),e),c.addListener(n,"keyup",t,e),c.addListener(n,"blur",t,e)}(e))}var r=e("./range_list").RangeList,s=e("./range").Range,a=e("./selection").Selection,l=e("./mouse/multi_select_handler").onMouseDown,c=e("./lib/event"),h=e("./lib/lang"),u=e("./commands/multi_select_commands")
t.commands=u.defaultCommands.concat(u.multiSelectCommands)
var d=new(0,e("./search").Search),g=e("./edit_session").EditSession;(function(){this.getSelectionMarkers=function(){return this.$selectionMarkers}}).call(g.prototype),function(){this.ranges=null,this.rangeList=null,this.addRange=function(e,t){if(e){if(!this.inMultiSelectMode&&0===this.rangeCount){var n=this.toOrientedRange()
...
this.ranges.splice(i,1)}this._signal("removeRange",{ranges:e}),0===this.rangeCount&&this.inMultiSelectMode&&(this.inMultiSelectMode=!1,this._signal("singleSelect"),this.session.$undoSelect=!0,this.rangeList.detach(this.session)),(t=t||this.ranges[0])&&!t.isEqual(this.getRange())&&this.fromOrientedRange(t)},this.$initRangeList=function(){this.rangeList||(this.rangeList=new r,this.ranges=[],this.rangeCount=0)},this.getAllRanges=function(){return this.rangeCount?this.rangeList.ranges.concat():[this.getRange()]},this.splitIntoLines=function(){for(var e=this.ranges.length?this.ranges:[this.getRange()],t=[],n=0;n<e.length;n++){var i=e[n],o=i.start.row,r=i.end.row
if(o===r)t.push(i.clone())
else{for(t.push(new s(o,i.start.column,o,this.session.getLine(o).length));++o<r;)t.push(this.getLineRange(o,!0))
t.push(new s(r,0,r,i.end.column))}0==n&&!this.isBackwards()&&(t=t.reverse())}this.toSingleRange()
for(n=t.length;n--;)this.addRange(t[n])},this.joinSelections=function(){var e=this.rangeList.ranges,t=e[e.length-1],n=s.fromPoints(e[0].start,t.end)
this.toSingleRange(),this.setSelectionRange(n,t.cursor==t.start)},this.toggleBlockSelection=function(){if(this.rangeCount>1){var e=this.rangeList.ranges,t=e[e.length-1],n=s.fromPoints(e[0].start,t.end)
this.toSingleRange(),this.setSelectionRange(n,t.cursor==t.start)}else{var i=this.session.documentToScreenPosition(this.cursor),o=this.session.documentToScreenPosition(this.anchor)
this.rectangularRangeBlock(i,o).forEach(this.addRange,this)}},this.rectangularRangeBlock=function(e,t,n){var o=[],r=e.column<t.column
if(r)var a=e.column,l=t.column,c=e.offsetX,h=t.offsetX
else a=t.column,l=e.column,c=t.offsetX,h=e.offsetX
var u,d=e.row<t.row
if(d)var g=e.row,p=t.row
else g=t.row,p=e.row
a<0&&(a=0),g<0&&(g=0),g==p&&(n=!0)
for(var f=g;f<=p;f++){var m=s.fromPoints(this.session.screenToDocumentPosition(f,a,c),this.session.screenToDocumentPosition(f,l,h))
if(m.isEmpty()){if(u&&i(m.end,u))break
u=m.end}m.cursor=r?m.start:m.end,o.push(m)}if(d&&o.reverse(),!n){for(var y=o.length-1;o[y].isEmpty()&&y>0;)y--
if(y>0)for(var v=0;o[v].isEmpty();)v++
for(var w=y;w>=v;w--)o[w].isEmpty()&&o.splice(w,1)}return o}}.call(a.prototype)
var p=e("./editor").Editor;(function(){this.updateSelectionMarkers=function(){this.renderer.updateCursor(),this.renderer.updateBackMarkers()},this.addSelectionMarker=function(e){e.cursor||(e.cursor=e.end)
...
n.multiSelect.addRange(n.multiSelect.toOrientedRange()),n.multiSelect.mergeOverlappingRanges()}return i}},this.forEachSelection=function(e,t,n){if(!this.inVirtualSelectionMode){var i,o=n&&n.keepOrder,r=1==n||n&&n.$byLines,s=this.session,l=this.selection,c=l.rangeList,h=(o?l:c).ranges
if(!h.length)return e.exec?e.exec(this,t||{}):e(this,t||{})
var u=l._eventRegistry
l._eventRegistry={}
var d=new a(s)
this.inVirtualSelectionMode=!0
for(var g=h.length;g--;){if(r)for(;g>0&&h[g].start.row==h[g-1].end.row;)g--
d.fromOrientedRange(h[g]),d.index=g,this.selection=s.selection=d
var p=e.exec?e.exec(this,t||{}):e(this,t||{})
!i&&void 0!==p&&(i=p),d.toOrientedRange(h[g])}d.detach(),this.selection=s.selection=l,this.inVirtualSelectionMode=!1,l._eventRegistry=u,l.mergeOverlappingRanges(),l.ranges[0]&&l.fromOrientedRange(l.ranges[0])
...
return i&&r.rangeList.rangeAtPoint(i.start)&&r.addRange(i,!0),o.length},this.selectMoreLines=function(e,t){var n=this.selection.toOrientedRange(),i=n.cursor==n.end,o=this.session.documentToScreenPosition(n.cursor)
...
this.selection.addRange(r),h&&this.selection.substractPoint(h)},this.transposeSelections=function(e){for(var t=this.session,n=t.multiSelect,i=n.ranges,o=i.length;o--;){if((a=i[o]).isEmpty()){var r=t.getWordRange(a.start.row,a.start.column)
...
for(o=i.length;o--;){var l=(a=i[o]).clone()
t.replace(a,s[o]),a.start.row=l.start.row,a.start.column=l.start.column}n.fromOrientedRange(n.ranges[0])},this.selectMore=function(e,t,n){var i=this.session,o=i.multiSelect.toOrientedRange()
if(!o.isEmpty()||((o=i.getWordRange(o.start.row,o.start.column)).cursor=-1==e?o.start:o.end,this.multiSelect.addRange(o),!n)){var r=i.getTextRange(o),s=function(e,t,n){return d.$options.wrap=!0,d.$options.needle=t,d.$options.backwards=-1==n,d.find(e)}(i,r,e)
s&&(s.cursor=-1==e?s.start:s.end,this.session.unfold(s),this.multiSelect.addRange(s),this.renderer.scrollCursorIntoView(null,.5)),t&&this.multiSelect.substractPoint(o.cursor)}},this.alignCursors=function(){var e=this.session,t=e.multiSelect,n=t.ranges,i=-1,o=n.filter((function(e){if(e.cursor.row==i)return!0
i=e.cursor.row}))
if(n.length&&o.length!=n.length-1){o.forEach((function(e){t.substractPoint(e.cursor)}))
var r=0,a=1/0,l=n.map((function(t){var n=t.cursor,i=e.getLine(n.row).substr(n.column).search(/\S/g)
return-1==i&&(i=0),n.column>r&&(r=n.column),i<a&&(a=i),i}))
n.forEach((function(t,n){var i=t.cursor,o=r-i.column,c=l[n]-a
o>c?e.insert(i,h.stringRepeat(" ",o-c)):e.remove(new s(i.row,i.column,i.row,i.column-o+c)),t.start.column=t.end.column=r,t.start.row=t.end.row=i.row,t.cursor=t.end})),t.fromOrientedRange(n[0]),this.renderer.updateCursor(),this.renderer.updateBackMarkers()}else{var c=this.selection.getRange(),u=c.start.row,d=c.end.row,g=u==d
...
m=this.$reAlignText(m,g),this.session.insert({row:u,column:0},m.join("\n")+"\n"),g||(c.start.column=0,c.end.column=m[m.length-1].length),this.selection.setRange(c)}},this.$reAlignText=function(e,t){function n(e){return h.stringRepeat(" ",e)}function i(e){return e[2]?n(o)+e[2]+n(r-e[2].length+s)+e[4].replace(/^([=:])\s+/,"$1 "):e[0]}var o,r,s,a=!0,l=!0
return e.map((function(e){var t=e.match(/(\s*)(.*?)(\s*)([=:].*)/)
return t?null==o?(o=t[1].length,r=t[2].length,s=t[3].length,t):(o+r+s!=t[1].length+t[2].length+t[3].length&&(l=!1),o!=t[1].length&&(a=!1),o>t[1].length&&(o=t[1].length),r<t[2].length&&(r=t[2].length),s>t[3].length&&(s=t[3].length),t):[e]})).map(t?i:a?l?function(e){return e[2]?n(o+r-e[2].length)+e[2]+n(s)+e[4].replace(/^([=:])\s+/,"$1 "):e[0]}:i:function(e){return e[2]?n(o)+e[2]+n(s)+e[4].replace(/^([=:])\s+/,"$1 "):e[0]})}}).call(p.prototype),t.onSessionChange=function(e){var t=e.session
...
if(a)return a.column++,s.column--,i.fromPoints(a,s)}}).call(o.prototype)})),ace.define("ace/ext/error_marker",["require","exports","module","ace/lib/dom","ace/range","ace/config"],(function(e,t,n){"use strict"
function i(e,t,n){var i=e.getAnnotations().sort(r.comparePoints)
...
return a.length&&a}}}var o=e("../lib/dom"),r=e("../range").Range,s=e("../config").nls
t.showErrorMarker=function(e,t){var n=e.session,r=e.getCursorPosition(),a=r.row,l=n.widgetManager.getWidgetsAtRow(a).filter((function(e){return"errorMarker"==e.type}))[0]
l?l.destroy():a-=t
var c,h=i(n,a,t)
if(h){var u=h[0]
r.column=(u.pos&&"number"!=typeof u.column?u.pos.sc:u.column)||0,r.row=u.row,c=e.renderer.$gutterLayer.$annotations[r.row]}else{if(l)return
c={displayText:[s("error-marker.good-state","Looks good!")],className:"ace_ok"}}e.session.unfold(r.row),e.selection.moveToPosition(r)
var d={row:r.row,fixedWidth:!0,coverGutter:!0,el:o.createElement("div"),type:"errorMarker"},g=d.el.appendChild(o.createElement("div")),p=d.el.appendChild(o.createElement("div"))
p.className="error_widget_arrow "+c.className
var f=e.renderer.$cursorLayer.getPixelPosition(r).left
p.style.left=f+e.renderer.gutterWidth-5+"px",d.el.className="error_widget_wrapper",g.className="error_widget "+c.className,c.displayText.forEach((function(e,t){g.appendChild(o.createTextNode(e)),t<c.displayText.length-1&&g.appendChild(o.createElement("br"))})),g.appendChild(o.createElement("div"))
...
return n.setUndoManager(new a),n},t.Range=o,t.Editor=r,t.EditSession=s,t.UndoManager=a,t.VirtualRenderer=l
var c=t.config.version
t.version=c}))
ace.require(["ace/ace"],(function(e){e&&(e.config.init(!0),e.define=ace.define)
var t=function(){return this}()
for(var n in t||"undefined"==typeof window||(t=window),t||"undefined"==typeof self||(t=self),t.ace||(t.ace=e),e)e.hasOwnProperty(n)&&(t.ace[n]=e[n])
t.ace.default=t.ace,"object"==typeof module&&"object"==typeof exports&&module&&(module.exports=t.ace)}))
